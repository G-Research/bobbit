...
// The selector-only harness below intentionally isolates tryAutoSelectModel. Real
// SessionManager/catalog boundaries live in controlled-model-fallback-session-manager.test.ts.
