...
import { chunkText } from "../../../src/server/search/chunker.js";
...
describe("chunkText", () => {
	...
	it("short text → single chunk with deterministic id", () => {
	...
	it("2001 tokens → 2 chunks with verifiable overlap", () => {
	...
	it("deterministic ids across invocations", () => {
	...
	it("single short text idempotent", () => {
