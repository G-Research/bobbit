...
1. **`rg "<symbol-or-symptom>" docs/ tests/ src/`** — design constraints, rationale, and pinning tests live there. Read the hits before writing code. Prefer LSP tools over grep for symbol lookup — see [docs/lsp.md](docs/lsp.md).
