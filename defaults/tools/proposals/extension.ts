	...
	pi.registerTool({
		...
		parameters: Type.Object({
			...
			components: Type.Optional(Type.Array(Type.Object({
				...
				env: Type.Optional(Type.Record(Type.String(), Type.String(), { description: "Literal plaintext command environment. Only for named workflow commands; never secrets." })),
