...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		parameters: Type.Object({
			...
			test_e2e_smoke_command: Type.Optional(Type.String({ description: "E2E smoke test command" })),
			test_e2e_standard_command: Type.Optional(Type.String({ description: "E2E standard test command" })),
