...
This page preserves the shipped Bobbit-side contract for that historical upgrade. For current Pi runtime compatibility boundaries and the selected Pi `0.82.1` runtime notes, see [Pi runtime compatibility](pi-runtime-compatibility.md).
