...
This page preserves the shipped Bobbit-side contract for that historical upgrade. For the current selected Pi runtime and compatibility boundaries, see [Pi runtime compatibility](pi-runtime-compatibility.md).
