...
Existing defaults remain important: external mode is dormant until configured, `retainEveryNTurns` remains 5, `retainMaxDelayMs` remains 30 minutes, `retainOverlapTurns` remains 2, `recallBudget` remains 1200, and `timeoutMs` remains 1500 ms.
