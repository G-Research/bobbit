...
|------------------------|-------------------------------------------|---------------------------------------|
| Pre-implementation     | None — no diff is run                     | `content: true` AND no `depends_on`   |
