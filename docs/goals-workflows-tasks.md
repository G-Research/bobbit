...
| `paused`                | `boolean?`                                    | REST (any goal)                                                                            | User can pause a goal mid-flight. Children may inherit via cascade. A paused child does NOT suppress the parent's idle nudge (paused != failed).                          |
