...
- **Sidebar appearance**: Per-browser controls tune sidebar font size and nested tree indentation without affecting chat typography, expansion-state keys, or project ordering. See [sidebar-tree-indentation.md](sidebar-tree-indentation.md).
