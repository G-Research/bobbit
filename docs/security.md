...
| WebSocket | Exact allowed browser `Origin`; supplied Fetch Metadata must describe a same-origin socket | Admission runs before either session/viewer upgrade and before first-frame authentication. |
