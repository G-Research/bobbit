...
Since v0.6.0 (#334), installing the then-unscoped `bobbit` package (`npm install bobbit`) failed in network-restricted environments. The package has since moved to `@gresearch/bobbit`; the original failure was caused by:
