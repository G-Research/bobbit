...
| `gate_status_changed` | `goalId`, `gateId`, `status`, `verificationStatus?`, `cancellation?` | Gate status changed. Cancellation metadata distinguishes the latest interrupted verification from a failed gate. |
