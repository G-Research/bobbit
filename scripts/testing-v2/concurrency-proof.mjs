...
function budgetsConcurrency() {
	try {
		const b = JSON.parse(readFileSync(join(REPO_ROOT, "tests", "support", "data", "shared", "budgets.json"), "utf8"));
...
// Concurrency target comes from tests/support/data/shared/budgets.json (concurrency.runs); env
