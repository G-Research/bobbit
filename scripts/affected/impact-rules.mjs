...
export const UNRESOLVED_REPOSITORY_READ_AUDIT = Object.freeze([
	...
	{
		consumer: "tests2/core/pi-packed-consumer-offline.test.ts",
		allowReason: "test-owned temporary consumer manifest generated by the packed-cache prewarm fixture",
		reads: frozen([
			{ expression: "join(options.cwd, \"package.json\")", count: 1 },
		]),
	},
	{
