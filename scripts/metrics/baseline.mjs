...
const coverageMap = `# Split UI E2E coverage map\n\nGenerated by \`npm run metrics:baseline\`. Update this file whenever browser E2E coverage is migrated to cheaper layers. Baseline metric files are committed as \`docs/testing-metrics/baseline-<name>.json\`; current runtime metrics remain unprefixed under \`.profiles/metrics/<name>.json\`.\n\n| Target behavior | Current full-browser E2E coverage | Replacement unit/fixture/API coverage | Retained full-stack smoke coverage | Baseline metric slice |\n|---|---|---|---|---|\n| Renderer, panels, status widgets, cost popovers, dynamic tabs | TBD during baseline capture | TBD before renderer migration deletions | TBD retained smoke list | \`baseline-slice-renderer.json\` |\n| Scroll, tail-follow, jump-to-last-prompt, viewport geometry | TBD during baseline capture | TBD before scroll migration deletions | TBD retained smoke list | \`baseline-slice-scroll.json\` |\n| Sidebar navigation, archived rows, ordering, selection, persistence | TBD during baseline capture | TBD before sidebar migration deletions | TBD retained smoke list | \`baseline-slice-sidebar.json\` |\n\n## Baseline metric files\n\n${baselineFiles.map((file) => `- \`${file}\``).join("\n")}\n\nThresholds: \`thresholds.json\`.\n`;
