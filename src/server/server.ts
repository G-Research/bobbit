...
import { registerGoalLifecycleRoutes } from "./routes/goal-lifecycle-routes.js";
...
import { registerExtensionHostInvocationRoutes } from "./routes/extension-host-invocation-routes.js";
...
registerExtensionHostInvocationRoutes(coreRouteTable);
registerGoalGateMutationRoutes(coreRouteTable);
...
async function handleApiRoute(
	...
	// goals G2b, goal lifecycle/archive routes
	// (src/server/routes/goal-lifecycle-routes.ts).
	// goals G3a, heavy gate signal/inspect routes
	...
	// cohort 30, extension-host invocation routes
	// (src/server/routes/extension-host-invocation-routes.ts).
	// goals G3b, gate mutation routes
	// (src/server/routes/goal-gate-mutation-routes.ts).
	{
		...
		if (coreMatch) {
			const coreCtx: CoreRouteCtx = {
				...
				extensionChannelServices, mintScopedExtensionChannelOpenPermit, notePackStoreWrite, orchestrationCore,
				resolveManagedRuntimeContext, routeDispatcher, routeRegistry,
	...
	// DELETE /api/goals/:parentId/archive-child/:childId, and
	// DELETE /api/goals/:id moved to the core route registry
	// (STR-01 goals cohort G2b) — see src/server/routes/goal-lifecycle-routes.ts.
	...
	// POST /api/ext/surface-token, POST /api/ext/channel-open-permit,
	// POST /api/ext/store/:op, GET /api/ext/session/{transcript,tool-call},
	// POST /api/ext/route/:name, and GET/POST /api/ext/pack-route/:packId/:routeName
	// moved to the core route registry (STR-01 cohort 30) — see
	// src/server/routes/extension-host-invocation-routes.ts and
	// docs/design/route-registry.md.
	...
	// GET /api/goals/:goalId/gates/:gateId/inspect moved to the core route
	// registry (STR-01 goals cohort G3a) — see
	// src/server/routes/goal-gate-heavy-routes.ts.

	// POST /api/goals/:goalId/gates/:gateId/reset and
	// POST /api/goals/:goalId/gates/:gateId/bypass moved to the core route
	// registry (STR-01 goals cohort G3b) — see
	// src/server/routes/goal-gate-mutation-routes.ts.

	// POST /api/goals/:goalId/gates/:gateId/signal moved to the core route
	// registry (STR-01 goals cohort G3a) — see
	// src/server/routes/goal-gate-heavy-routes.ts.
	...
	// POST /api/goals/:goalId/gates/:gateId/cancel-verification and
	// POST /api/goals/:goalId/gates/:gateId/signoff moved to the core route
	// registry (STR-01 goals cohort G3b) — see
	// src/server/routes/goal-gate-mutation-routes.ts.
	...
	// GET /api/goals/:goalId/workflow-context/:gateId moved to the core route
	// registry (STR-01 goals cohort G3b) — see
	// src/server/routes/goal-gate-mutation-routes.ts.
