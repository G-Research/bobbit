...
// Both `panels` (B4) and `routes` (B3) have graduated from reserved-shape-only to
// typed parsers; `stores` graduated in B1. `entrypoints` remains reserved (C1).
const RESERVED_KEYS = ["entrypoints"] as const;
