...
export class GoalManager {
	...
	async updateGoal(id: string, updates: { title?: string; cwd?: string; state?: GoalState; spec?: string; team?: boolean; repoPath?: string; branch?: string; prUrl?: string; reattemptOf?: string; projectId?: string; autoStartTeam?: boolean; spawnedFromPlanId?: string; divergencePolicy?: "strict" | "balanced" | "autonomous"; maxConcurrentChildren?: number }): Promise<boolean> {
