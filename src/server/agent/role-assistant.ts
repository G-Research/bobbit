...
- **accessory**: (optional) Pixel-art accessory for the agent's avatar. Options: crown, bandana, ponytail, magnifier, palette, set-square, pencil, shield, wizard-hat, none.
