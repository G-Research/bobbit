	...
	private runCommandStep(
		...
		return new Promise((resolve) => {
			...
			const observeContainerPayloadCompletion = (text: string) => {
				...
				const marker = `BOBBIT_CONTAINER_PAYLOAD_EXIT:${pidNonce}:`;
