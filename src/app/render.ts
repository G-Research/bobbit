												...
												<div class="flex items-center gap-1.5 pl-0.5 pr-2 py-1.5 rounded-md cursor-pointer active:bg-secondary/50 transition-colors"
													...
													>
														<span class="relative inline-flex" style="width:18px;height:18px;">
															<span style="position:absolute;top:0;left:0;">${icon(GoalIcon, "md")}</span>
															<svg viewBox="0 0 10 10" style="position:absolute;bottom:-2px;right:-3px;width:9px;height:9px;">
