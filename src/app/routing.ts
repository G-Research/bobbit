...
export type SettingsTabId = "shortcuts" | "general" | "project" | "components" | "models" | "palette" | "directories" | "account" | "appearance" | "maintenance";

const SETTINGS_TABS = new Set<SettingsTabId>(["shortcuts", "general", "project", "components", "models", "palette", "directories", "account", "appearance", "maintenance"]);
