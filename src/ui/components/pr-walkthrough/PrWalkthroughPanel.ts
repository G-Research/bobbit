...
export class PrWalkthroughPanel extends LitElement {
	...
	static override styles = css`
		...
		* { box-sizing: border-box; }
		...
		.title-wrap { min-width: 0; display: grid; gap: 1px; flex: 1 1 auto; }
		...
		.actions .decision-icon { width: 15px; height: 15px; margin-right: 6px; vertical-align: -2px; fill: none; stroke: currentColor; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round; }
			...
			<article class="card" data-testid="pr-walkthrough-card" data-active="true" data-card-id=${card.id} data-phase-id=${card.phaseId}>
				<div class="inner">
					...
					<div class="actions">
						...
						<button data-testid="pr-walkthrough-like" class="like" type="button" @click=${() => this.recordDecision(card, "liked")}><svg class="decision-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M7 10v12"></path><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2h0a3.13 3.13 0 0 1 3 3.88Z"></path></svg>${commentCount ? "Like anyway" : "Like"} →</button>
					</div>
				</div>
			</article>
		`;
