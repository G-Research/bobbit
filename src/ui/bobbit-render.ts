...
// ============================================================================
// SPRITE DATA → ACCESSORY DEF BRIDGE
// ============================================================================
...
/**
 * Render an idle blob using canvas with the same layout as the role manager cards.
 ...
 * Draws body, eyes, and accessories to canvas <img> elements.
