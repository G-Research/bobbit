...
// Source: tests/output-path-containment.test.ts
...
import { withEnv, type EnvPatch } from "../../../tests/support/harnesses/shared/with-env.js";
...
// Applied per-execute via withEnv so BOBBIT_* are restored between calls and
// never clobber an ambient BOBBIT_DIR set by another file in the fork.
let envPatch: EnvPatch;
...
beforeAll(() => {
	...
	envPatch = {
		BOBBIT_DIR: path.join(workDir, ".bobbit"),
		BOBBIT_GATEWAY_URL: "http://127.0.0.1:1",
		BOBBIT_TOKEN: "test-token",
		BOBBIT_SESSION_ID: "11111111-1111-1111-1111-111111111111",
	};
