// Ported from tests/e2e/marketplace-provider-activation.spec.ts (v2-integration tier).
//
// Pure REST coverage for the additive pack-activation shape: provider refs and
// the schema-v2 catalogue arrays persist through GET/PUT without any provider
// runtime dispatch; schema-1 packs omit the schema-v2 catalogue arrays.
//
