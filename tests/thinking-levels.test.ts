...
test("clampThinkingLevel: high on OpenRouter GLM 5.2 stays high but xhigh clamps to high", () => {
	const glm52: ModelLike = { id: "z-ai/glm-5.2", provider: "openrouter", reasoning: true };
