...
\f\r"'\`<>=]|("|')|))|$)`, "g");
      ...
      x = (t6) => (i6, ...s5) => ({ _$litType$: t6, strings: i6, values: s5 });
      b2 = x(1);
      w = x(2);
      T = x(3);
      ...
      N = (t6, i6) => {
        ...
        let n7, l5 = 2 === i6 ? "<svg>" : 3 === i6 ? "<math>" : "", c5 = v;
        for (let i7 = 0; i7 < s5; i7++) {
          const s6 = t6[i7];
          let a3, u3, d4 = -1, f4 = 0;
          for (; f4 < s6.length && (c5.lastIndex = f4, u3 = c5.exec(s6), null !== u3); ) f4 = c5.lastIndex, c5 === v ? "!--" === u3[1] ? c5 = _ : void 0 !== u3[1] ? c5 = m : void 0 !== u3[2] ? (y2.test(u3[2]) && (n7 = RegExp("</" + u3[2], "g")), c5 = p2) : void 0 !== u3[3] && (c5 = p2) : c5 === p2 ? ">" === u3[0] ? (c5 = n7 ?? v, d4 = -1) : void 0 === u3[1] ? d4 = -2 : (d4 = c5.lastIndex - u3[2].length, a3 = u3[1], c5 = void 0 === u3[3] ? p2 : '"' === u3[3] ? $ : g) : c5 === $ || c5 === g ? c5 = p2 : c5 === _ || c5 === m ? c5 = v : (c5 = p2, n7 = void 0);
          const x3 = c5 === p2 && t6[i7 + 1].startsWith("/>") ? " " : "";
          l5 += c5 === v ? s6 + r3 : d4 >= 0 ? (e8.push(a3), s6.slice(0, d4) + h2 + s6.slice(d4) + o3 + x3) : s6 + o3 + (-2 === d4 ? i7 : x3);
        }
        return [V(t6, l5 + (t6[s5] || "<?>") + (2 === i6 ? "</svg>" : 3 === i6 ? "</math>" : "")), e8];
      };
      S2 = class _S {
        constructor({ strings: t6, _$litType$: i6 }, e8) {
          ...
          this.parts = [];
          let l5 = 0, a3 = 0;
          const u3 = t6.length - 1, d4 = this.parts, [f4, v3] = N(t6, i6);
          if (this.el = _S.createElement(f4, e8), P.currentNode = this.el.content, 2 === i6 || 3 === i6) {
            const t7 = this.el.content.firstChild;
            t7.replaceWith(...t7.childNodes);
          }
          for (; null !== (r8 = P.nextNode()) && d4.length < u3; ) {
            if (1 === r8.nodeType) {
              if (r8.hasAttributes()) for (const t7 of r8.getAttributeNames()) if (t7.endsWith(h2)) {
                const i7 = v3[a3++], s5 = r8.getAttribute(t7).split(o3), e9 = /([.?@])?(.*)/.exec(i7);
                d4.push({ type: 1, index: l5, name: e9[2], strings: s5, ctor: "." === e9[1] ? I : "?" === e9[1] ? L : "@" === e9[1] ? z : H }), r8.removeAttribute(t7);
              } else t7.startsWith(o3) && (d4.push({ type: 6, index: l5 }), r8.removeAttribute(t7));
              if (y2.test(r8.tagName)) {
                const t7 = r8.textContent.split(o3), i7 = t7.length - 1;
                if (i7 > 0) {
                  r8.textContent = s2 ? s2.emptyScript : "";
                  for (let s5 = 0; s5 < i7; s5++) r8.append(t7[s5], c3()), P.nextNode(), d4.push({ type: 2, index: ++l5 });
                  r8.append(t7[i7], c3());
                }
              }
            } else if (8 === r8.nodeType) if (r8.data === n3) d4.push({ type: 2, index: l5 });
            else {
              let t7 = -1;
              for (; -1 !== (t7 = r8.data.indexOf(o3, t7 + 1)); ) d4.push({ type: 7, index: l5 }), t7 += o3.length - 1;
            }
            l5++;
          }
        }
  ...
  var init_directive = __esm({
    "node_modules/lit-html/directive.js"() {
      ...
      e4 = (t6) => (...e8) => ({ _$litDirective$: t6, values: e8 });
      i5 = class {
        constructor(t6) {
        }
        get _$AU() {
  ...
  function n4(i6, t6 = false, e8 = 0) {
    ...
    if (void 0 !== h4 && 0 !== h4.size) if (t6) if (Array.isArray(r8)) for (let i7 = e8; i7 < r8.length; i7++) s4(r8[i7], false), o5(r8[i7]);
  ...
  // node_modules/@mariozechner/mini-lit/dist/component.js
  ...
  // node_modules/@mariozechner/mini-lit/dist/index.js
  var init_dist = __esm({
    "node_modules/@mariozechner/mini-lit/dist/index.js"() {
      "use strict";
      init_component();
  ...
  function n6(t6) {
    return (e8, o9) => "object" == typeof o9 ? r6(t6, e8, o9) : ((t7, e9, o10) => {
  ...
  var init_katex = __esm({
    "node_modules/katex/dist/katex.mjs"() {
      ...
      doubleBrushStroke = (svgPath) => svgPath + " " + svgPath;
      hLinePad = 80;
      ...
      for (i6 = 0; i6 < mathTextSymbols.length; i6++) {
        ch = mathTextSymbols.charAt(i6);
      ...
      wideCharacterFont = (wideChar2, mode) => {
        ...
        if (119808 <= codePoint && codePoint < 120484) {
          ...
          return [wideLatinLetterData[i6][2], wideLatinLetterData[i6][j3]];
      ...
      makeSpan = function makeSpan2(classes, children, options, style) {
        ...
        formLigatures(group) {
          ...
          for (var i6 = 0; i6 < n7; ++i6) {
            ...
            if (v3 === "-" && next.text === "-") {
              ...
              if (i6 + 1 < n7 && afterNext && afterNext.type === "textord" && afterNext.text === "-") {
                group.splice(i6, 3, {
                  type: "textord",
                  mode: "text",
  ...
  // node_modules/@mariozechner/mini-lit/node_modules/marked/lib/marked.esm.js
  function L2() {
  ...
  function d3(l5, e8 = "") {
    let t6 = typeof l5 == "string" ? l5 : l5.source, n7 = { replace: (r8, i6) => {
      let s5 = typeof i6 == "string" ? i6 : i6.source;
      return s5 = s5.replace(m2.caret, "$1"), t6 = t6.replace(r8, s5), n7;
    }, getRegex: () => new RegExp(t6, e8) };
    return n7;
  }
  function w2(l5, e8) {
    if (e8) {
  ...
  function V2(l5, e8) {
    let t6 = l5.replace(m2.findPipe, (i6, s5, a3) => {
      let o9 = false, p3 = s5;
      for (; --p3 >= 0 && a3[p3] === "\\"; ) o9 = !o9;
      return o9 ? "|" : " |";
    }), n7 = t6.split(m2.splitPipe), r8 = 0;
    if (n7[0].trim() || n7.shift(), n7.length > 0 && !n7.at(-1)?.trim() && n7.pop(), e8) if (n7.length > e8) n7.splice(e8);
    else for (; n7.length < e8; ) n7.push("");
    for (; r8 < n7.length; r8++) n7[r8] = n7[r8].trim().replace(m2.slashPipe, "|");
    return n7;
  }
  function z2(l5, e8, t6) {
    let n7 = l5.length;
    if (n7 === 0) return "";
    let r8 = 0;
    for (; r8 < n7; ) {
      let i6 = l5.charAt(n7 - r8 - 1);
      if (i6 === e8 && !t6) r8++;
      else if (i6 !== e8 && t6) r8++;
      else break;
    }
  ...
  function fe(l5, e8) {
    if (l5.indexOf(e8[1]) === -1) return -1;
    let t6 = 0;
    for (let n7 = 0; n7 < l5.length; n7++) if (l5[n7] === "\\") n7++;
    else if (l5[n7] === e8[0]) t6++;
    else if (l5[n7] === e8[1] && (t6--, t6 < 0)) return n7;
    return t6 > 0 ? -2 : -1;
  }
  function me(l5, e8, t6, n7, r8) {
    let i6 = e8.href, s5 = e8.title || null, a3 = l5[1].replace(r8.other.outputLinkReplace, "$1");
    n7.state.inLink = true;
    let o9 = { type: l5[0].charAt(0) === "!" ? "image" : "link", raw: t6, href: i6, title: s5, text: a3, tokens: n7.inlineTokens(a3) };
    return n7.state.inLink = false, o9;
  }
  function Ye(l5, e8, t6) {
    let n7 = l5.match(t6.other.indentCodeCompensation);
    if (n7 === null) return e8;
    let r8 = n7[1];
    return e8.split(`
`).map((i6) => {
      let s5 = i6.match(t6.other.beginningSpace);
      if (s5 === null) return i6;
      let [a3] = s5;
      return a3.length >= r8.length ? i6.slice(r8.length) : i6;
    }).join(`
`);
  }
  function k2(l5, e8) {
    return _2.parse(l5, e8);
  }
  var T3, E2, be, m2, Re, Te, Oe, I2, we, F, ie, oe, ye, j2, Pe, Q, Se, $e, v2, U, _e, ae, Le, K, re, Me, ze, Ae, Ee, le, Ie, D3, W, ue, Ce, pe, Be, qe, ve, ce, De, He, he, Ze, Ge, Ne, Fe, je, Qe, Ue, q, Ke, de, ke, We, se, X, Xe, N2, Je, C2, M2, Ve, ge, y3, x2, P2, $2, b3, S4, B2, _2, Zt, Gt, Nt, Ft, jt, Ut, Kt;
  var init_marked_esm = __esm({
    "node_modules/@mariozechner/mini-lit/node_modules/marked/lib/marked.esm.js"() {
      ...
      oe = d3(ie).replace(/bull/g, F).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex();
      ye = d3(ie).replace(/bull/g, F).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex();
      j2 = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/;
      Pe = /^[^\n]+/;
      Q = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/;
      Se = d3(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", Q).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex();
      $e = d3(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, F).getRegex();
      v2 = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul";
      U = /<!--(?:-?>|[\s\S]*?(?:-->|$))/;
      _e = d3("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", U).replace("tag", v2).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex();
      ae = d3(j2).replace("hr", I2).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v2).getRegex();
      Le = d3(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", ae).getRegex();
      K = { blockquote: Le, code: Te, def: Se, fences: Oe, heading: we, hr: I2, html: _e, lheading: oe, list: $e, newline: Re, paragraph: ae, table: E2, text: Pe };
      re = d3("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", I2).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v2).getRegex();
      Me = { ...K, lheading: ye, table: re, paragraph: d3(j2).replace("hr", I2).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", re).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v2).getRegex() };
      ze = { ...K, html: d3(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", U).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: E2, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: d3(j2).replace("hr", I2).replace("heading", ` *#{1,6} *[^
      ...
      W = /[\s\p{P}\p{S}]/u;
      ue = /[^\s\p{P}\p{S}]/u;
      Ce = d3(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, W).getRegex();
      pe = /(?!~)[\p{P}\p{S}]/u;
      Be = /(?!~)[\s\p{P}\p{S}]/u;
      qe = /(?:[^\s\p{P}\p{S}]|~)/u;
      ve = d3(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", be ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex();
      ce = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/;
      De = d3(ce, "u").replace(/punct/g, D3).getRegex();
      He = d3(ce, "u").replace(/punct/g, pe).getRegex();
      he = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)";
      Ze = d3(he, "gu").replace(/notPunctSpace/g, ue).replace(/punctSpace/g, W).replace(/punct/g, D3).getRegex();
      Ge = d3(he, "gu").replace(/notPunctSpace/g, qe).replace(/punctSpace/g, Be).replace(/punct/g, pe).getRegex();
      Ne = d3("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, ue).replace(/punctSpace/g, W).replace(/punct/g, D3).getRegex();
      Fe = d3(/\\(punct)/, "gu").replace(/punct/g, D3).getRegex();
      je = d3(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex();
      Qe = d3(U).replace("(?:-->|$)", "-->").getRegex();
      Ue = d3("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", Qe).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex();
      q = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/;
      Ke = d3(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", q).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex();
      de = d3(/^!?\[(label)\]\[(ref)\]/).replace("label", q).replace("ref", Q).getRegex();
      ke = d3(/^!?\[(ref)\](?:\[\])?/).replace("ref", Q).getRegex();
      We = d3("reflink|nolink(?!\\()", "g").replace("reflink", de).replace("nolink", ke).getRegex();
      se = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/;
      X = { _backpedal: E2, anyPunctuation: Fe, autolink: je, blockSkip: ve, br: le, code: Ee, del: E2, emStrongLDelim: De, emStrongRDelimAst: Ze, emStrongRDelimUnd: Ne, escape: Ae, link: Ke, nolink: ke, punctuation: Ce, reflink: de, reflinkSearch: We, tag: Ue, text: Ie, url: E2 };
      Xe = { ...X, link: d3(/^!?\[(label)\]\((.*?)\)/).replace("label", q).getRegex(), reflink: d3(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", q).getRegex() };
      N2 = { ...X, emStrongRDelimAst: Ge, emStrongLDelim: He, url: d3(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", se).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/, text: d3(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", se).getRegex() };
      Je = { ...N2, br: d3(le).replace("{2,}", "*").getRegex(), text: d3(N2.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() };
      C2 = { normal: K, gfm: Me, pedantic: ze };
      M2 = { normal: X, gfm: N2, breaks: Je, pedantic: Xe };
      Ve = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
      ge = (l5) => Ve[l5];
      y3 = class {
        options;
        ...
        space(e8) {
          let t6 = this.rules.block.newline.exec(e8);
          if (t6 && t6[0].length > 0) return { type: "space", raw: t6[0] };
        }
        code(e8) {
          let t6 = this.rules.block.code.exec(e8);
          if (t6) {
...
`) };
        ...
        fences(e8) {
          let t6 = this.rules.block.fences.exec(e8);
          if (t6) {
        ...
        heading(e8) {
          let t6 = this.rules.block.heading.exec(e8);
          if (t6) {
            let n7 = t6[2].trim();
        ...
        hr(e8) {
          let t6 = this.rules.block.hr.exec(e8);
          if (t6) return { type: "hr", raw: z2(t6[0], `
`) };
        }
        blockquote(e8) {
          let t6 = this.rules.block.blockquote.exec(e8);
          if (t6) {
            let n7 = z2(t6[0], `
`).split(`
`), r8 = "", i6 = "", s5 = [];
            for (; n7.length > 0; ) {
              let a3 = false, o9 = [], p3;
              for (p3 = 0; p3 < n7.length; p3++) if (this.rules.other.blockquoteStart.test(n7[p3])) o9.push(n7[p3]), a3 = true;
              else if (!a3) o9.push(n7[p3]);
              else break;
              n7 = n7.slice(p3);
              let u3 = o9.join(`
...
${c5}` : c5;
              ...
              if (this.lexer.state.top = true, this.lexer.blockTokens(c5, s5, true), this.lexer.state.top = g2, n7.length === 0) break;
              let h4 = s5.at(-1);
...
`), O = this.blockquote(f4);
                s5[s5.length - 1] = O, r8 = r8.substring(0, r8.length - R2.raw.length) + O.raw, i6 = i6.substring(0, i6.length - R2.text.length) + O.text;
                break;
              } else if (h4?.type === "list") {
                let R2 = h4, f4 = R2.raw + `
` + n7.join(`
`), O = this.list(f4);
                s5[s5.length - 1] = O, r8 = r8.substring(0, r8.length - h4.raw.length) + O.raw, i6 = i6.substring(0, i6.length - R2.raw.length) + O.raw, n7 = f4.substring(s5.at(-1).raw.length).split(`
`);
                continue;
              }
            }
            return { type: "blockquote", raw: r8, tokens: s5, text: i6 };
          }
        }
        list(e8) {
          let t6 = this.rules.block.list.exec(e8);
          if (t6) {
            let n7 = t6[1].trim(), r8 = n7.length > 1, i6 = { type: "list", raw: "", ordered: r8, start: r8 ? +n7.slice(0, -1) : "", loose: false, items: [] };
            n7 = r8 ? `\\d{1,9}\\${n7.slice(-1)}` : `\\${n7}`, this.options.pedantic && (n7 = r8 ? n7 : "[*+-]");
            let s5 = this.rules.other.listItemRegex(n7), a3 = false;
            for (; e8; ) {
              let p3 = false, u3 = "", c5 = "";
              if (!(t6 = s5.exec(e8)) || this.rules.block.hr.test(e8)) break;
              u3 = t6[0], e8 = e8.substring(u3.length);
              let g2 = t6[2].split(`
`, 1)[0].replace(this.rules.other.listReplaceTabs, (H2) => " ".repeat(3 * H2.length)), h4 = e8.split(`
`, 1)[0], R2 = !g2.trim(), f4 = 0;
              if (this.options.pedantic ? (f4 = 2, c5 = g2.trimStart()) : R2 ? f4 = t6[1].length + 1 : (f4 = t6[2].search(this.rules.other.nonSpaceChar), f4 = f4 > 4 ? 1 : f4, c5 = g2.slice(f4), f4 += t6[1].length), R2 && this.rules.other.blankLine.test(h4) && (u3 += h4 + `
`, e8 = e8.substring(h4.length + 1), p3 = true), !p3) {
                ...
                for (; e8; ) {
                  let Z2 = e8.split(`
`, 1)[0], A2;
                  if (h4 = Z2, this.options.pedantic ? (h4 = h4.replace(this.rules.other.listReplaceNesting, "  "), A2 = h4) : A2 = h4.replace(this.rules.other.tabCharGlobal, "    "), te.test(h4) || ne.test(h4) || xe.test(h4) || H2.test(h4) || ee.test(h4)) break;
                  if (A2.search(this.rules.other.nonSpaceChar) >= f4 || !h4.trim()) c5 += `
` + A2.slice(f4);
                  else {
...
` + h4;
                  ...
                  !R2 && !h4.trim() && (R2 = true), u3 += Z2 + `
`, e8 = e8.substring(Z2.length + 1), g2 = A2.slice(f4);
                }
              }
              i6.loose || (a3 ? i6.loose = true : this.rules.other.doubleBlankLine.test(u3) && (a3 = true));
              let O = null, Y;
              this.options.gfm && (O = this.rules.other.listIsTask.exec(c5), O && (Y = O[0] !== "[ ] ", c5 = c5.replace(this.rules.other.listReplaceTask, ""))), i6.items.push({ type: "list_item", raw: u3, task: !!O, checked: Y, loose: false, text: c5, tokens: [] }), i6.raw += u3;
            }
            let o9 = i6.items.at(-1);
            if (o9) o9.raw = o9.raw.trimEnd(), o9.text = o9.text.trimEnd();
            else return;
            i6.raw = i6.raw.trimEnd();
            for (let p3 = 0; p3 < i6.items.length; p3++) if (this.lexer.state.top = false, i6.items[p3].tokens = this.lexer.blockTokens(i6.items[p3].text, []), !i6.loose) {
              let u3 = i6.items[p3].tokens.filter((g2) => g2.type === "space"), c5 = u3.length > 0 && u3.some((g2) => this.rules.other.anyLine.test(g2.raw));
              i6.loose = c5;
            }
            if (i6.loose) for (let p3 = 0; p3 < i6.items.length; p3++) i6.items[p3].loose = true;
            return i6;
          }
        }
        html(e8) {
          let t6 = this.rules.block.html.exec(e8);
          if (t6) return { type: "html", block: true, raw: t6[0], pre: t6[1] === "pre" || t6[1] === "script" || t6[1] === "style", text: t6[0] };
        }
        def(e8) {
          let t6 = this.rules.block.def.exec(e8);
          if (t6) {
            let n7 = t6[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal, " "), r8 = t6[2] ? t6[2].replace(this.rules.other.hrefBrackets, "$1").replace(this.rules.inline.anyPunctuation, "$1") : "", i6 = t6[3] ? t6[3].substring(1, t6[3].length - 1).replace(this.rules.inline.anyPunctuation, "$1") : t6[3];
            return { type: "def", tag: n7, raw: t6[0], href: r8, title: i6 };
          }
        }
        table(e8) {
          let t6 = this.rules.block.table.exec(e8);
          if (!t6 || !this.rules.other.tableDelimiter.test(t6[2])) return;
          let n7 = V2(t6[1]), r8 = t6[2].replace(this.rules.other.tableAlignChars, "").split("|"), i6 = t6[3]?.trim() ? t6[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], s5 = { type: "table", raw: t6[0], header: [], align: [], rows: [] };
          if (n7.length === r8.length) {
            for (let a3 of r8) this.rules.other.tableAlignRight.test(a3) ? s5.align.push("right") : this.rules.other.tableAlignCenter.test(a3) ? s5.align.push("center") : this.rules.other.tableAlignLeft.test(a3) ? s5.align.push("left") : s5.align.push(null);
            for (let a3 = 0; a3 < n7.length; a3++) s5.header.push({ text: n7[a3], tokens: this.lexer.inline(n7[a3]), header: true, align: s5.align[a3] });
            for (let a3 of i6) s5.rows.push(V2(a3, s5.header.length).map((o9, p3) => ({ text: o9, tokens: this.lexer.inline(o9), header: false, align: s5.align[p3] })));
            return s5;
          }
        }
        lheading(e8) {
          let t6 = this.rules.block.lheading.exec(e8);
          if (t6) return { type: "heading", raw: t6[0], depth: t6[2].charAt(0) === "=" ? 1 : 2, text: t6[1], tokens: this.lexer.inline(t6[1]) };
        }
        paragraph(e8) {
          let t6 = this.rules.block.paragraph.exec(e8);
          if (t6) {
...
` ? t6[1].slice(0, -1) : t6[1];
        ...
        link(e8) {
          let t6 = this.rules.inline.link.exec(e8);
          if (t6) {
            let n7 = t6[2].trim();
            if (!this.options.pedantic && this.rules.other.startAngleBracket.test(n7)) {
              if (!this.rules.other.endAngleBracket.test(n7)) return;
              let s5 = z2(n7.slice(0, -1), "\\");
              if ((n7.length - s5.length) % 2 === 0) return;
            } else {
              let s5 = fe(t6[2], "()");
              if (s5 === -2) return;
              if (s5 > -1) {
                let o9 = (t6[0].indexOf("!") === 0 ? 5 : 4) + t6[1].length + s5;
                t6[2] = t6[2].substring(0, s5), t6[0] = t6[0].substring(0, o9).trim(), t6[3] = "";
              }
            }
            let r8 = t6[2], i6 = "";
            if (this.options.pedantic) {
              let s5 = this.rules.other.pedanticHrefTitle.exec(r8);
              s5 && (r8 = s5[1], i6 = s5[3]);
            } else i6 = t6[3] ? t6[3].slice(1, -1) : "";
            return r8 = r8.trim(), this.rules.other.startAngleBracket.test(r8) && (this.options.pedantic && !this.rules.other.endAngleBracket.test(n7) ? r8 = r8.slice(1) : r8 = r8.slice(1, -1)), me(t6, { href: r8 && r8.replace(this.rules.inline.anyPunctuation, "$1"), title: i6 && i6.replace(this.rules.inline.anyPunctuation, "$1") }, t6[0], this.lexer, this.rules);
          }
        }
        reflink(e8, t6) {
          let n7;
          if ((n7 = this.rules.inline.reflink.exec(e8)) || (n7 = this.rules.inline.nolink.exec(e8))) {
            let r8 = (n7[2] || n7[1]).replace(this.rules.other.multipleSpaceGlobal, " "), i6 = t6[r8.toLowerCase()];
            if (!i6) {
              let s5 = n7[0].charAt(0);
              return { type: "text", raw: s5, text: s5 };
            }
            return me(n7, i6, n7[0], this.lexer, this.rules);
          }
        }
        emStrong(e8, t6, n7 = "") {
          let r8 = this.rules.inline.emStrongLDelim.exec(e8);
          if (!r8 || r8[3] && n7.match(this.rules.other.unicodeAlphaNumeric)) return;
          if (!(r8[1] || r8[2] || "") || !n7 || this.rules.inline.punctuation.exec(n7)) {
            let s5 = [...r8[0]].length - 1, a3, o9, p3 = s5, u3 = 0, c5 = r8[0][0] === "*" ? this.rules.inline.emStrongRDelimAst : this.rules.inline.emStrongRDelimUnd;
            for (c5.lastIndex = 0, t6 = t6.slice(-1 * e8.length + s5); (r8 = c5.exec(t6)) != null; ) {
              if (a3 = r8[1] || r8[2] || r8[3] || r8[4] || r8[5] || r8[6], !a3) continue;
              if (o9 = [...a3].length, r8[3] || r8[4]) {
                p3 += o9;
                continue;
              } else if ((r8[5] || r8[6]) && s5 % 3 && !((s5 + o9) % 3)) {
                u3 += o9;
                continue;
              }
              if (p3 -= o9, p3 > 0) continue;
              o9 = Math.min(o9, o9 + p3 + u3);
              let g2 = [...r8[0]][0].length, h4 = e8.slice(0, s5 + r8.index + g2 + o9);
              if (Math.min(s5, o9) % 2) {
                let f4 = h4.slice(1, -1);
                return { type: "em", raw: h4, text: f4, tokens: this.lexer.inlineTokens(f4) };
              }
              let R2 = h4.slice(2, -2);
        ...
        codespan(e8) {
          let t6 = this.rules.inline.code.exec(e8);
          if (t6) {
            let n7 = t6[2].replace(this.rules.other.newLineCharGlobal, " "), r8 = this.rules.other.nonSpaceChar.test(n7), i6 = this.rules.other.startingSpaceChar.test(n7) && this.rules.other.endingSpaceChar.test(n7);
            return r8 && i6 && (n7 = n7.substring(1, n7.length - 1)), { type: "codespan", raw: t6[0], text: n7 };
          }
        }
        br(e8) {
          let t6 = this.rules.inline.br.exec(e8);
          if (t6) return { type: "br", raw: t6[0] };
        }
        del(e8) {
          let t6 = this.rules.inline.del.exec(e8);
          if (t6) return { type: "del", raw: t6[0], text: t6[2], tokens: this.lexer.inlineTokens(t6[2]) };
        }
        autolink(e8) {
          let t6 = this.rules.inline.autolink.exec(e8);
          if (t6) {
            let n7, r8;
        ...
        url(e8) {
          let t6;
          if (t6 = this.rules.inline.url.exec(e8)) {
            let n7, r8;
            if (t6[2] === "@") n7 = t6[0], r8 = "mailto:" + n7;
            else {
              let i6;
              do
                i6 = t6[0], t6[0] = this.rules.inline._backpedal.exec(t6[0])?.[0] ?? "";
              while (i6 !== t6[0]);
        ...
        inlineText(e8) {
          let t6 = this.rules.inline.text.exec(e8);
          if (t6) {
      ...
      x2 = class l3 {
        ...
        inlineQueue;
        constructor(e8) {
          this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e8 || T3, this.options.tokenizer = this.options.tokenizer || new y3(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = { inLink: false, inRawBlock: false, top: true };
          let t6 = { other: m2, block: C2.normal, inline: M2.normal };
          this.options.pedantic ? (t6.block = C2.pedantic, t6.inline = M2.pedantic) : this.options.gfm && (t6.block = C2.gfm, this.options.breaks ? t6.inline = M2.breaks : t6.inline = M2.gfm), this.tokenizer.rules = t6;
        }
        static get rules() {
          return { block: C2, inline: M2 };
        }
        static lex(e8, t6) {
          return new l3(t6).lex(e8);
        }
        static lexInline(e8, t6) {
          return new l3(t6).inlineTokens(e8);
        }
        lex(e8) {
          e8 = e8.replace(m2.carriageReturn, `
`), this.blockTokens(e8, this.tokens);
        ...
        blockTokens(e8, t6 = [], n7 = false) {
          for (this.options.pedantic && (e8 = e8.replace(m2.tabCharGlobal, "    ").replace(m2.spaceLine, "")); e8; ) {
            let r8;
            if (this.options.extensions?.block?.some((s5) => (r8 = s5.call({ lexer: this }, e8, t6)) ? (e8 = e8.substring(r8.raw.length), t6.push(r8), true) : false)) continue;
            if (r8 = this.tokenizer.space(e8)) {
              e8 = e8.substring(r8.raw.length);
              let s5 = t6.at(-1);
              r8.raw.length === 1 && s5 !== void 0 ? s5.raw += `
` : t6.push(r8);
              continue;
            }
            if (r8 = this.tokenizer.code(e8)) {
              e8 = e8.substring(r8.raw.length);
              let s5 = t6.at(-1);
              s5?.type === "paragraph" || s5?.type === "text" ? (s5.raw += (s5.raw.endsWith(`
`) ? "" : `
`) + r8.raw, s5.text += `
` + r8.text, this.inlineQueue.at(-1).src = s5.text) : t6.push(r8);
              continue;
            }
            if (r8 = this.tokenizer.fences(e8)) {
              e8 = e8.substring(r8.raw.length), t6.push(r8);
              continue;
            }
            if (r8 = this.tokenizer.heading(e8)) {
              e8 = e8.substring(r8.raw.length), t6.push(r8);
              continue;
            }
            if (r8 = this.tokenizer.hr(e8)) {
              e8 = e8.substring(r8.raw.length), t6.push(r8);
              continue;
            }
            if (r8 = this.tokenizer.blockquote(e8)) {
              e8 = e8.substring(r8.raw.length), t6.push(r8);
              continue;
            }
            if (r8 = this.tokenizer.list(e8)) {
              e8 = e8.substring(r8.raw.length), t6.push(r8);
              continue;
            }
            if (r8 = this.tokenizer.html(e8)) {
              e8 = e8.substring(r8.raw.length), t6.push(r8);
              continue;
            }
            if (r8 = this.tokenizer.def(e8)) {
              e8 = e8.substring(r8.raw.length);
              let s5 = t6.at(-1);
              s5?.type === "paragraph" || s5?.type === "text" ? (s5.raw += (s5.raw.endsWith(`
`) ? "" : `
`) + r8.raw, s5.text += `
` + r8.raw, this.inlineQueue.at(-1).src = s5.text) : this.tokens.links[r8.tag] || (this.tokens.links[r8.tag] = { href: r8.href, title: r8.title }, t6.push(r8));
              continue;
            }
            if (r8 = this.tokenizer.table(e8)) {
              e8 = e8.substring(r8.raw.length), t6.push(r8);
              continue;
            }
            if (r8 = this.tokenizer.lheading(e8)) {
              e8 = e8.substring(r8.raw.length), t6.push(r8);
              continue;
            }
            let i6 = e8;
            if (this.options.extensions?.startBlock) {
              let s5 = 1 / 0, a3 = e8.slice(1), o9;
              this.options.extensions.startBlock.forEach((p3) => {
                o9 = p3.call({ lexer: this }, a3), typeof o9 == "number" && o9 >= 0 && (s5 = Math.min(s5, o9));
              }), s5 < 1 / 0 && s5 >= 0 && (i6 = e8.substring(0, s5 + 1));
            }
            if (this.state.top && (r8 = this.tokenizer.paragraph(i6))) {
              let s5 = t6.at(-1);
              n7 && s5?.type === "paragraph" ? (s5.raw += (s5.raw.endsWith(`
`) ? "" : `
`) + r8.raw, s5.text += `
` + r8.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = s5.text) : t6.push(r8), n7 = i6.length !== e8.length, e8 = e8.substring(r8.raw.length);
              continue;
            }
            if (r8 = this.tokenizer.text(e8)) {
              e8 = e8.substring(r8.raw.length);
              let s5 = t6.at(-1);
              s5?.type === "text" ? (s5.raw += (s5.raw.endsWith(`
`) ? "" : `
`) + r8.raw, s5.text += `
` + r8.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = s5.text) : t6.push(r8);
              continue;
            }
            if (e8) {
              let s5 = "Infinite loop on byte: " + e8.charCodeAt(0);
              if (this.options.silent) {
                console.error(s5);
                break;
              } else throw new Error(s5);
            }
          }
          return this.state.top = true, t6;
        }
        inline(e8, t6 = []) {
          return this.inlineQueue.push({ src: e8, tokens: t6 }), t6;
        }
        inlineTokens(e8, t6 = []) {
          let n7 = e8, r8 = null;
          ...
          let i6;
          for (; (r8 = this.tokenizer.rules.inline.blockSkip.exec(n7)) != null; ) i6 = r8[2] ? r8[2].length : 0, n7 = n7.slice(0, r8.index + i6) + "[" + "a".repeat(r8[0].length - i6 - 2) + "]" + n7.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
          n7 = this.options.hooks?.emStrongMask?.call({ lexer: this }, n7) ?? n7;
          let s5 = false, a3 = "";
          for (; e8; ) {
            s5 || (a3 = ""), s5 = false;
            let o9;
            if (this.options.extensions?.inline?.some((u3) => (o9 = u3.call({ lexer: this }, e8, t6)) ? (e8 = e8.substring(o9.raw.length), t6.push(o9), true) : false)) continue;
            if (o9 = this.tokenizer.escape(e8)) {
              e8 = e8.substring(o9.raw.length), t6.push(o9);
              continue;
            }
            if (o9 = this.tokenizer.tag(e8)) {
              e8 = e8.substring(o9.raw.length), t6.push(o9);
              continue;
            }
            if (o9 = this.tokenizer.link(e8)) {
              e8 = e8.substring(o9.raw.length), t6.push(o9);
              continue;
            }
            if (o9 = this.tokenizer.reflink(e8, this.tokens.links)) {
              e8 = e8.substring(o9.raw.length);
              let u3 = t6.at(-1);
              o9.type === "text" && u3?.type === "text" ? (u3.raw += o9.raw, u3.text += o9.text) : t6.push(o9);
              continue;
            }
            if (o9 = this.tokenizer.emStrong(e8, n7, a3)) {
              e8 = e8.substring(o9.raw.length), t6.push(o9);
              continue;
            }
            if (o9 = this.tokenizer.codespan(e8)) {
              e8 = e8.substring(o9.raw.length), t6.push(o9);
              continue;
            }
            if (o9 = this.tokenizer.br(e8)) {
              e8 = e8.substring(o9.raw.length), t6.push(o9);
              continue;
            }
            if (o9 = this.tokenizer.del(e8)) {
              e8 = e8.substring(o9.raw.length), t6.push(o9);
              continue;
            }
            if (o9 = this.tokenizer.autolink(e8)) {
              e8 = e8.substring(o9.raw.length), t6.push(o9);
              continue;
            }
            if (!this.state.inLink && (o9 = this.tokenizer.url(e8))) {
              e8 = e8.substring(o9.raw.length), t6.push(o9);
              continue;
            }
            let p3 = e8;
            if (this.options.extensions?.startInline) {
              let u3 = 1 / 0, c5 = e8.slice(1), g2;
              this.options.extensions.startInline.forEach((h4) => {
                g2 = h4.call({ lexer: this }, c5), typeof g2 == "number" && g2 >= 0 && (u3 = Math.min(u3, g2));
              }), u3 < 1 / 0 && u3 >= 0 && (p3 = e8.substring(0, u3 + 1));
            }
            if (o9 = this.tokenizer.inlineText(p3)) {
              e8 = e8.substring(o9.raw.length), o9.raw.slice(-1) !== "_" && (a3 = o9.raw.slice(-1)), s5 = true;
              let u3 = t6.at(-1);
              u3?.type === "text" ? (u3.raw += o9.raw, u3.text += o9.text) : t6.push(o9);
              continue;
            }
            if (e8) {
              let u3 = "Infinite loop on byte: " + e8.charCodeAt(0);
              if (this.options.silent) {
                console.error(u3);
                break;
      ...
      P2 = class {
        ...
        code({ text: e8, lang: t6, escaped: n7 }) {
          let r8 = (t6 || "").match(m2.notSpaceStart)?.[0], i6 = e8.replace(m2.endingNewline, "") + `
`;
          return r8 ? '<pre><code class="language-' + w2(r8) + '">' + (n7 ? i6 : w2(i6, true)) + `</code></pre>
` : "<pre><code>" + (n7 ? i6 : w2(i6, true)) + `</code></pre>
`;
        }
...
`;
        ...
        heading({ tokens: e8, depth: t6 }) {
          return `<h${t6}>${this.parser.parseInline(e8)}</h${t6}>
`;
        }
        hr(e8) {
          return `<hr>
`;
        ...
        list(e8) {
          let t6 = e8.ordered, n7 = e8.start, r8 = "";
          for (let a3 = 0; a3 < e8.items.length; a3++) {
            let o9 = e8.items[a3];
            r8 += this.listitem(o9);
          }
          let i6 = t6 ? "ol" : "ul", s5 = t6 && n7 !== 1 ? ' start="' + n7 + '"' : "";
          return "<" + i6 + s5 + `>
` + r8 + "</" + i6 + `>
`;
        }
        listitem(e8) {
          let t6 = "";
          if (e8.task) {
            let n7 = this.checkbox({ checked: !!e8.checked });
            e8.loose ? e8.tokens[0]?.type === "paragraph" ? (e8.tokens[0].text = n7 + " " + e8.tokens[0].text, e8.tokens[0].tokens && e8.tokens[0].tokens.length > 0 && e8.tokens[0].tokens[0].type === "text" && (e8.tokens[0].tokens[0].text = n7 + " " + w2(e8.tokens[0].tokens[0].text), e8.tokens[0].tokens[0].escaped = true)) : e8.tokens.unshift({ type: "text", raw: n7 + " ", text: n7 + " ", escaped: true }) : t6 += n7 + " ";
          }
          return t6 += this.parser.parse(e8.tokens, !!e8.loose), `<li>${t6}</li>
`;
        }
        checkbox({ checked: e8 }) {
...
`;
        ...
        table(e8) {
          let t6 = "", n7 = "";
          for (let i6 = 0; i6 < e8.header.length; i6++) n7 += this.tablecell(e8.header[i6]);
          t6 += this.tablerow({ text: n7 });
          let r8 = "";
          for (let i6 = 0; i6 < e8.rows.length; i6++) {
            let s5 = e8.rows[i6];
            n7 = "";
            for (let a3 = 0; a3 < s5.length; a3++) n7 += this.tablecell(s5[a3]);
...
`;
        ...
        tablecell(e8) {
          let t6 = this.parser.parseInline(e8.tokens), n7 = e8.header ? "th" : "td";
          return (e8.align ? `<${n7} align="${e8.align}">` : `<${n7}>`) + t6 + `</${n7}>
`;
        }
        strong({ tokens: e8 }) {
        ...
        link({ href: e8, title: t6, tokens: n7 }) {
          let r8 = this.parser.parseInline(n7), i6 = J(e8);
          if (i6 === null) return r8;
          e8 = i6;
          let s5 = '<a href="' + e8 + '"';
          return t6 && (s5 += ' title="' + w2(t6) + '"'), s5 += ">" + r8 + "</a>", s5;
        }
        image({ href: e8, title: t6, text: n7, tokens: r8 }) {
          r8 && (n7 = this.parser.parseInline(r8, this.parser.textRenderer));
          let i6 = J(e8);
          if (i6 === null) return w2(n7);
          e8 = i6;
          let s5 = `<img src="${e8}" alt="${n7}"`;
          return t6 && (s5 += ` title="${w2(t6)}"`), s5 += ">", s5;
        }
        text(e8) {
          return "tokens" in e8 && e8.tokens ? this.parser.parseInline(e8.tokens) : "escaped" in e8 && e8.escaped ? e8.text : w2(e8.text);
        }
      };
      $2 = class {
        strong({ text: e8 }) {
      ...
      b3 = class l4 {
        ...
        textRenderer;
        constructor(e8) {
          this.options = e8 || T3, this.options.renderer = this.options.renderer || new P2(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new $2();
        }
        static parse(e8, t6) {
          return new l4(t6).parse(e8);
        }
        static parseInline(e8, t6) {
          return new l4(t6).parseInline(e8);
        }
        parse(e8, t6 = true) {
          let n7 = "";
          for (let r8 = 0; r8 < e8.length; r8++) {
            let i6 = e8[r8];
            if (this.options.extensions?.renderers?.[i6.type]) {
              let a3 = i6, o9 = this.options.extensions.renderers[a3.type].call({ parser: this }, a3);
            ...
            switch (s5.type) {
              case "space": {
                n7 += this.renderer.space(s5);
                continue;
              }
              case "hr": {
                n7 += this.renderer.hr(s5);
                continue;
              }
              case "heading": {
                n7 += this.renderer.heading(s5);
                continue;
              }
              case "code": {
                n7 += this.renderer.code(s5);
                continue;
              }
              case "table": {
                n7 += this.renderer.table(s5);
                continue;
              }
              case "blockquote": {
                n7 += this.renderer.blockquote(s5);
                continue;
              }
              case "list": {
                n7 += this.renderer.list(s5);
                continue;
              }
              case "html": {
                n7 += this.renderer.html(s5);
                continue;
              }
              case "def": {
                n7 += this.renderer.def(s5);
                continue;
              }
              case "paragraph": {
                n7 += this.renderer.paragraph(s5);
                continue;
              }
              case "text": {
                let a3 = s5, o9 = this.renderer.text(a3);
                for (; r8 + 1 < e8.length && e8[r8 + 1].type === "text"; ) a3 = e8[++r8], o9 += `
` + this.renderer.text(a3);
              ...
              default: {
                let a3 = 'Token with "' + s5.type + '" type was not found.';
        ...
        parseInline(e8, t6 = this.renderer) {
          let n7 = "";
          for (let r8 = 0; r8 < e8.length; r8++) {
            let i6 = e8[r8];
            if (this.options.extensions?.renderers?.[i6.type]) {
      ...
      B2 = class {
        ...
        walkTokens(e8, t6) {
          let n7 = [];
          for (let r8 of e8) switch (n7 = n7.concat(t6.call(this, r8)), r8.type) {
            case "table": {
              let i6 = r8;
              for (let s5 of i6.header) n7 = n7.concat(this.walkTokens(s5.tokens, t6));
              for (let s5 of i6.rows) for (let a3 of s5) n7 = n7.concat(this.walkTokens(a3.tokens, t6));
              break;
            }
            case "list": {
              let i6 = r8;
              n7 = n7.concat(this.walkTokens(i6.items, t6));
              break;
            }
            default: {
              let i6 = r8;
              this.defaults.extensions?.childTokens?.[i6.type] ? this.defaults.extensions.childTokens[i6.type].forEach((s5) => {
                let a3 = i6[s5].flat(1 / 0);
                n7 = n7.concat(this.walkTokens(a3, t6));
              }) : i6.tokens && (n7 = n7.concat(this.walkTokens(i6.tokens, t6)));
            }
          }
          return n7;
        }
        use(...e8) {
          ...
          return e8.forEach((n7) => {
            let r8 = { ...n7 };
            if (r8.async = this.defaults.async || r8.async || false, n7.extensions && (n7.extensions.forEach((i6) => {
              if (!i6.name) throw new Error("extension name required");
              if ("renderer" in i6) {
                let s5 = t6.renderers[i6.name];
                s5 ? t6.renderers[i6.name] = function(...a3) {
                  let o9 = i6.renderer.apply(this, a3);
                  return o9 === false && (o9 = s5.apply(this, a3)), o9;
                } : t6.renderers[i6.name] = i6.renderer;
              }
              if ("tokenizer" in i6) {
                if (!i6.level || i6.level !== "block" && i6.level !== "inline") throw new Error("extension level must be 'block' or 'inline'");
                let s5 = t6[i6.level];
                s5 ? s5.unshift(i6.tokenizer) : t6[i6.level] = [i6.tokenizer], i6.start && (i6.level === "block" ? t6.startBlock ? t6.startBlock.push(i6.start) : t6.startBlock = [i6.start] : i6.level === "inline" && (t6.startInline ? t6.startInline.push(i6.start) : t6.startInline = [i6.start]));
              }
              "childTokens" in i6 && i6.childTokens && (t6.childTokens[i6.name] = i6.childTokens);
            }), r8.extensions = t6), n7.renderer) {
              let i6 = this.defaults.renderer || new P2(this.defaults);
              for (let s5 in n7.renderer) {
                if (!(s5 in i6)) throw new Error(`renderer '${s5}' does not exist`);
                if (["options", "parser"].includes(s5)) continue;
                let a3 = s5, o9 = n7.renderer[a3], p3 = i6[a3];
                i6[a3] = (...u3) => {
                  let c5 = o9.apply(i6, u3);
                  return c5 === false && (c5 = p3.apply(i6, u3)), c5 || "";
                };
              }
              r8.renderer = i6;
            }
            if (n7.tokenizer) {
              ...
              for (let s5 in n7.tokenizer) {
                if (!(s5 in i6)) throw new Error(`tokenizer '${s5}' does not exist`);
                if (["options", "rules", "lexer"].includes(s5)) continue;
                let a3 = s5, o9 = n7.tokenizer[a3], p3 = i6[a3];
                i6[a3] = (...u3) => {
                  let c5 = o9.apply(i6, u3);
                  return c5 === false && (c5 = p3.apply(i6, u3)), c5;
                };
            ...
            if (n7.hooks) {
              let i6 = this.defaults.hooks || new S4();
              for (let s5 in n7.hooks) {
                if (!(s5 in i6)) throw new Error(`hook '${s5}' does not exist`);
                if (["options", "block"].includes(s5)) continue;
                let a3 = s5, o9 = n7.hooks[a3], p3 = i6[a3];
                S4.passThroughHooks.has(s5) ? i6[a3] = (u3) => {
                  if (this.defaults.async && S4.passThroughHooksRespectAsync.has(s5)) return (async () => {
                    let g2 = await o9.call(i6, u3);
                    return p3.call(i6, g2);
                  })();
                  let c5 = o9.call(i6, u3);
                  return p3.call(i6, c5);
                } : i6[a3] = (...u3) => {
                  if (this.defaults.async) return (async () => {
                    let g2 = await o9.apply(i6, u3);
                    return g2 === false && (g2 = await p3.apply(i6, u3)), g2;
                  })();
                  let c5 = o9.apply(i6, u3);
                  return c5 === false && (c5 = p3.apply(i6, u3)), c5;
                };
            ...
            if (n7.walkTokens) {
              let i6 = this.defaults.walkTokens, s5 = n7.walkTokens;
              r8.walkTokens = function(a3) {
                let o9 = [];
                return o9.push(s5.call(this, a3)), i6 && (o9 = o9.concat(i6.call(this, a3))), o9;
              };
            }
        ...
        lexer(e8, t6) {
          return x2.lex(e8, t6 ?? this.defaults);
        }
        parser(e8, t6) {
          return b3.parse(e8, t6 ?? this.defaults);
        }
        parseMarkdown(e8) {
          return (n7, r8) => {
            let i6 = { ...r8 }, s5 = { ...this.defaults, ...i6 }, a3 = this.onError(!!s5.silent, !!s5.async);
            ...
            if (s5.hooks && (s5.hooks.options = s5, s5.hooks.block = e8), s5.async) return (async () => {
              let o9 = s5.hooks ? await s5.hooks.preprocess(n7) : n7, u3 = await (s5.hooks ? await s5.hooks.provideLexer() : e8 ? x2.lex : x2.lexInline)(o9, s5), c5 = s5.hooks ? await s5.hooks.processAllTokens(u3) : u3;
              s5.walkTokens && await Promise.all(this.walkTokens(c5, s5.walkTokens));
              let h4 = await (s5.hooks ? await s5.hooks.provideParser() : e8 ? b3.parse : b3.parseInline)(c5, s5);
              return s5.hooks ? await s5.hooks.postprocess(h4) : h4;
            })().catch(a3);
            try {
              s5.hooks && (n7 = s5.hooks.preprocess(n7));
              let p3 = (s5.hooks ? s5.hooks.provideLexer() : e8 ? x2.lex : x2.lexInline)(n7, s5);
              s5.hooks && (p3 = s5.hooks.processAllTokens(p3)), s5.walkTokens && this.walkTokens(p3, s5.walkTokens);
              let c5 = (s5.hooks ? s5.hooks.provideParser() : e8 ? b3.parse : b3.parseInline)(p3, s5);
              return s5.hooks && (c5 = s5.hooks.postprocess(c5)), c5;
            } catch (o9) {
              return a3(o9);
            }
          };
...
Please report this to https://github.com/markedjs/marked.`, e8) {
      ...
      k2.walkTokens = function(l5, e8) {
        return _2.walkTokens(l5, e8);
      };
  ...
  var MarkdownBlock_exports = {};
  __export(MarkdownBlock_exports, {
    MarkdownBlock: () => MarkdownBlock
  });
  var __decorate, MarkdownBlock;
  var init_MarkdownBlock = __esm({
    "node_modules/@mariozechner/mini-lit/dist/MarkdownBlock.js"() {
      ...
      __decorate = function(decorators, target, key, desc) {
        ...
        else for (var i6 = decorators.length - 1; i6 >= 0; i6--) if (d4 = decorators[i6]) r8 = (c5 < 3 ? d4(r8) : c5 > 3 ? d4(target, key, r8) : d4(target, key)) || r8;
  ...
  // src/ui/lazy/markdown-block.ts
  function ensureMarkdownBlock() {
    if (loaded) return;
    loaded = true;
    Promise.resolve().then(() => init_MarkdownBlock());
  }
  var loaded;
  var init_markdown_block = __esm({
    "src/ui/lazy/markdown-block.ts"() {
      "use strict";
      loaded = false;
    }
  ...
  var LiveTimer;
  var init_LiveTimer = __esm({
    "src/ui/components/LiveTimer.ts"() {
      "use strict";
      init_lit();
      init_decorators();
      LiveTimer = class extends i4 {
        constructor() {
          super(...arguments);
        ...
        render() {
          const referenceTime = !this.running && typeof this.endTime === "number" && Number.isFinite(this.endTime) ? this.endTime : Date.now();
          const elapsed = Math.max(0, Math.round((referenceTime - this.startTime) / 1e3));
          if (!Number.isFinite(elapsed)) return b2`—`;
      ...
      __decorateClass([
        n6({ type: Number })
      ], LiveTimer.prototype, "startTime", 2);
      __decorateClass([
        n6({ type: Number })
      ], LiveTimer.prototype, "endTime", 2);
      __decorateClass([
        n6({ type: Boolean })
      ], LiveTimer.prototype, "running", 2);
      customElements.define("live-timer", LiveTimer);
    }
  });

  // src/ui/utils/ansi.ts
  function color256(n7) {
    if (n7 < 16) return COLORS_16[n7];
    if (n7 < 232) {
      const idx = n7 - 16;
      const b4 = idx % 6 * 51;
      const g2 = Math.floor(idx / 6) % 6 * 51;
      const r8 = Math.floor(idx / 36) * 51;
      return `rgb(${r8},${g2},${b4})`;
    }
    const v3 = (n7 - 232) * 10 + 8;
    return `rgb(${v3},${v3},${v3})`;
  }
  function stateToStyle(s5) {
    const parts = [];
    if (s5.bold) parts.push("font-weight:bold");
    if (s5.dim) parts.push("opacity:0.6");
    if (s5.italic) parts.push("font-style:italic");
    if (s5.underline) parts.push("text-decoration:underline");
    if (s5.inverse) {
      const fg = s5.bg || "var(--console-bg, #1e1e1e)";
      const bg = s5.fg || "var(--console-fg, currentColor)";
      parts.push(`color:${fg}`, `background-color:${bg}`);
    } else {
      if (s5.fg) parts.push(`color:${s5.fg}`);
      if (s5.bg) parts.push(`background-color:${s5.bg}`);
    }
    return parts.join(";");
  }
  function resetState() {
  ...
  function ansiToHtml(input) {
    if (!input) return "";
    if (!input.includes("\x1B") && !input.includes("\x1B")) {
      return escapeHtml(input);
    }
    const result = [];
    let state = resetState();
    let spanOpen = false;
    const re2 = /\x1b\[([0-9;]*)m/g;
    let lastIndex = 0;
    let match;
    while ((match = re2.exec(input)) !== null) {
      if (match.index > lastIndex) {
        const text2 = input.slice(lastIndex, match.index);
        if (text2) {
          ...
          result.push(escapeHtml(text2));
        }
      }
      lastIndex = re2.lastIndex;
      const codes = match[1] ? match[1].split(";").map(Number) : [0];
      for (let i6 = 0; i6 < codes.length; i6++) {
        const c5 = codes[i6];
        if (c5 === 0) {
          state = resetState();
        } else if (c5 === 1) {
          ...
          state.fg = COLORS_16[c5 - 30];
        } else if (c5 === 38) {
          if (codes[i6 + 1] === 5 && i6 + 2 < codes.length) {
            state.fg = color256(codes[i6 + 2]);
            i6 += 2;
          } else if (codes[i6 + 1] === 2 && i6 + 4 < codes.length) {
            state.fg = `rgb(${codes[i6 + 2]},${codes[i6 + 3]},${codes[i6 + 4]})`;
            i6 += 4;
          }
        } else if (c5 === 39) {
          state.fg = null;
        } else if (c5 >= 40 && c5 <= 47) {
          state.bg = COLORS_16[c5 - 40];
        } else if (c5 === 48) {
          if (codes[i6 + 1] === 5 && i6 + 2 < codes.length) {
            state.bg = color256(codes[i6 + 2]);
            i6 += 2;
          } else if (codes[i6 + 1] === 2 && i6 + 4 < codes.length) {
            state.bg = `rgb(${codes[i6 + 2]},${codes[i6 + 3]},${codes[i6 + 4]})`;
            i6 += 4;
          }
        } else if (c5 === 49) {
          state.bg = null;
        } else if (c5 >= 90 && c5 <= 97) {
          state.fg = COLORS_16[c5 - 90 + 8];
        } else if (c5 >= 100 && c5 <= 107) {
          state.bg = COLORS_16[c5 - 100 + 8];
        }
      }
    }
    if (lastIndex < input.length) {
      const text2 = input.slice(lastIndex);
      if (text2) {
        const style = stateToStyle(state);
        if (style) {
          if (spanOpen) result.push("</span>");
  ...
  var init_ansi = __esm({
    "src/ui/utils/ansi.ts"() {
      ...
      COLORS_16 = [
        ...
        "var(--ansi-blue, #55f)",
        // 4: blue
        "var(--ansi-magenta, #f5f)",
        // 5: magenta
        "var(--ansi-cyan, #5dd)",
        // 6: cyan
        "var(--ansi-white, #ccc)",
        // 7: white
        "var(--ansi-bright-black, #888)",
        // 8: bright black
        "var(--ansi-bright-red, #f77)",
        // 9: bright red
        "var(--ansi-bright-green, #7f7)",
        // 10: bright green
        "var(--ansi-bright-yellow, #ff7)",
        // 11: bright yellow
        "var(--ansi-bright-blue, #77f)",
        // 12: bright blue
        "var(--ansi-bright-magenta, #f7f)",
        // 13: bright magenta
        "var(--ansi-bright-cyan, #7ff)",
        // 14: bright cyan
        "var(--ansi-bright-white, #fff)"
        // 15: bright white
      ];
    }
  });

  // src/app/verification-event-bus.ts
  function getVerificationEventKey(detail) {
    ...
    const text2 = detail.text ?? "";
    const status = detail.status ?? "";
    const startedAt = detail.startedAt ?? "";
    const durationMs = detail.durationMs ?? "";
    const phase = detail.phase ?? "";
    const ts = detail.ts ?? "";
    return `${type}|${signalId}|${stepIndex}|${stream}|${status}|${startedAt}|${durationMs}|${phase}|${ts}|${text2}`;
  }
  var init_verification_event_bus = __esm({
    "src/app/verification-event-bus.ts"() {
      "use strict";
    }
  });
  ...
  var VerificationOutputModal;
  var init_VerificationOutputModal = __esm({
    "src/ui/components/VerificationOutputModal.ts"() {
      "use strict";
      init_lit();
      init_decorators();
      ...
      init_markdown_block();
      init_ansi();
      init_verification_event_bus();
      VerificationOutputModal = class extends i4 {
        constructor() {
          super(...arguments);
          this.goalId = "";
          this.gateId = "";
          ...
          this._seenEvents = /* @__PURE__ */ new Set();
          this._seenEventsOrder = [];
        ...
        connectedCallback() {
          ...
          document.addEventListener("gate-verification-event", (e8) => this._onEvent(e8), { signal });
          document.addEventListener("keydown", (e8) => this._onKeyDown(e8), { signal });
        }
        disconnectedCallback() {
          super.disconnectedCallback();
          this._abortCtrl?.abort();
          this._abortCtrl = void 0;
        ...
        _markEventSeen(key) {
          ...
          if (this._seenEventsOrder.length > VerificationOutputModal._SEEN_CAP) {
            ...
            if (evict !== void 0) this._seenEvents.delete(evict);
          }
          return true;
        }
        updated(changed) {
          if (changed.has("open") && this.open) {
            ...
            if (this.initialOutput) {
              ...
              const seq = this.initialOutputSeq;
        ...
        async _fetchBootstrapOutput() {
          try {
            ...
            const match = verifications.find((v3) => v3.signalId === this.signalId);
            if (!match) return;
        ...
        _onBackdropClick(e8) {
          if (e8.target.classList.contains("verif-output-backdrop")) {
            this._close();
          }
        }
        render() {
				...
				<div class="verif-output-container flex flex-col rounded-lg overflow-hidden shadow-2xl"
					...
					<div class="flex items-center justify-between px-4 py-2.5 border-b" style="border-color:#27272a;">
						<div class="flex items-center gap-2">
							${this._completed ? b2`<span class="${this._finalStatus === "passed" ? "text-green-500" : "text-red-500"}">${this._finalStatus === "passed" ? "\u2713" : "\u2717"}</span>` : b2`<span class="text-amber-400 animate-pulse">\u25CF</span>`}
					...
					<!-- Body -->
					${this._isAgentStep() ? b2`<div class="verif-output-body flex-1 overflow-y-auto px-4 py-3 text-sm leading-relaxed"
							style="background:#18181b;margin:0;color:#d4d4d8;"
							@scroll=${this._onScroll}>${this._renderMarkdownOutput()}</div>` : b2`<pre class="verif-output-body flex-1 overflow-y-auto px-4 py-3 text-xs leading-relaxed"
        ...
        _renderMarkdownOutput() {
          if (this._chunks.length === 0) {
            return b2`<span style="color:#71717a;">Waiting for output\u2026</span>`;
          }
          const joined = this._chunks.map((c5) => c5.text).join("");
          return b2`<markdown-block .content=${joined}></markdown-block>`;
        }
        _renderOutput() {
          if (this._chunks.length === 0) {
            return b2`<span style="color:#71717a;">Waiting for output\u2026</span>`;
          }
          return b2`${this._chunks.map((c5) => {
            if (hasAnsi(c5.text)) {
              return b2`<span style="color:${c5.stream === "stderr" ? "#fbbf24" : "#d4d4d8"};">${o7(ansiToHtml(c5.text))}</span>`;
            }
            return c5.stream === "stderr" ? b2`<span style="color:#fbbf24;">${c5.text}</span>` : b2`<span style="color:#d4d4d8;">${c5.text}</span>`;
          })}`;
        }
      };
      VerificationOutputModal._SEEN_CAP = 2048;
      __decorateClass([
        n6()
      ], VerificationOutputModal.prototype, "goalId", 2);
      __decorateClass([
        n6()
      ], VerificationOutputModal.prototype, "gateId", 2);
      __decorateClass([
        n6()
      ], VerificationOutputModal.prototype, "signalId", 2);
      __decorateClass([
        n6({ type: Number })
      ], VerificationOutputModal.prototype, "stepIndex", 2);
      __decorateClass([
        n6()
      ], VerificationOutputModal.prototype, "stepName", 2);
      __decorateClass([
        n6({ type: Boolean })
      ], VerificationOutputModal.prototype, "open", 2);
      __decorateClass([
        n6()
      ], VerificationOutputModal.prototype, "initialOutput", 2);
      __decorateClass([
        n6()
      ], VerificationOutputModal.prototype, "stepType", 2);
      __decorateClass([
        r7()
      ], VerificationOutputModal.prototype, "_chunks", 2);
      __decorateClass([
        r7()
      ], VerificationOutputModal.prototype, "_completed", 2);
      __decorateClass([
        r7()
      ], VerificationOutputModal.prototype, "_finalStatus", 2);
      VerificationOutputModal = __decorateClass([
        t5("verification-output-modal")
  ...
  function formatDuration(ms) {
    const s5 = Math.round(ms / 1e3);
    return s5 < 60 ? `${s5}s` : `${Math.floor(s5 / 60)}m${s5 % 60}s`;
  }
  ...
  function renderSessionLink(sessionId) {
    if (!sessionId) return b2``;
    return b2`
  ...
  function renderDuration(entry) {
    if (entry.status === "running" || entry.status === "starting") {
      ...
      return b2`<span class="text-xs text-muted-foreground"><live-timer .startTime=${startTime} .running=${true}></live-timer></span>`;
    }
    return b2`<span class="text-xs text-muted-foreground">${formatDuration(entry.durationMs)}</span>`;
  }
  var init_delegate_cards = __esm({
    "src/ui/tools/renderers/delegate-cards.ts"() {
      "use strict";
      init_dist();
      init_lit();
  ...
  // src/ui/tools/renderers/GateVerificationLive.ts
  var GateVerificationLive_exports = {};
  __export(GateVerificationLive_exports, {
    GateVerificationLive: () => GateVerificationLive
  });
  function normalizeStepStatus(step, fallback = "running") {
  ...
  function mapVerificationStep(step, fallback = "running") {
  ...
  function hasExplicitStepStatus(step) {
  ...
  function toDelegateStatus(status) {
  ...
  function statusSummary(steps) {
    ...
    return labels.map(([status, label]) => {
      const count = counts.get(status) || 0;
      return count > 0 ? `${count} ${label}` : "";
    }).filter(Boolean).join(", ");
  }
  function shouldRenderDuration(step) {
  ...
  function toCardEntry(step, index) {
    ...
    const durationMs = step.status === "running" ? step.startedAt ? Math.max(0, Date.now() - step.startedAt) : step.durationMs ?? 0 : step.durationMs ?? 0;
    return {
      id: `step-${index}`,
      name: step.name || "step",
  ...
  var GateVerificationLive;
  var init_GateVerificationLive = __esm({
    "src/ui/tools/renderers/GateVerificationLive.ts"() {
      "use strict";
      init_lit();
      init_decorators();
      ...
      init_markdown_block();
      init_LiveTimer();
      init_VerificationOutputModal();
      init_ansi();
      init_verification_event_bus();
      init_delegate_cards();
      GateVerificationLive = class extends i4 {
        constructor() {
          super(...arguments);
          this.goalId = "";
          this.gateId = "";
          ...
          this._stepOutputs = /* @__PURE__ */ new Map();
          /** Per-instance dedupe window — collapses identical events delivered via
        ...
        willUpdate(_changed) {
          if (this.overallStatus === "idle" && this.steps.length === 0 && this.initialSteps.length > 0) {
            ...
            this.steps = this.initialSteps.map((s5) => mapVerificationStep(s5, fallback));
            this.overallStatus = this.finalStatus === "passed" || this.finalStatus === "failed" ? this.finalStatus : "running";
            for (let i6 = 0; i6 < this.steps.length; i6++) {
              if (this.steps[i6].output && !this._stepOutputs.has(i6)) this._stepOutputs.set(i6, this.steps[i6].output);
            }
          }
        }
        connectedCallback() {
          ...
          super.connectedCallback();
          this._abortCtrl = new AbortController();
          document.addEventListener("gate-verification-event", (e8) => this._onEvent(e8), { signal: this._abortCtrl.signal });
        ...
        disconnectedCallback() {
          ...
          if (this._reconcileTimer) {
            ...
            this._reconcileTimer = void 0;
          }
          if (this._outputFlushTimer) {
            clearTimeout(this._outputFlushTimer);
            this._outputFlushTimer = void 0;
          }
        }
        async _fetchAndReconcile() {
          ...
          try {
            ...
            const signal = gate.signals?.find((s5) => s5.id === this.signalId);
            ...
            if (vStatus === "passed" || vStatus === "failed") {
              ...
              const steps = (signal.verification.steps || []).map((s5) => mapVerificationStep(s5, fallback));
              this.steps = steps;
            ...
            if (vStatus === "running") {
              ...
              try {
                ...
                if (activeRes.ok) {
                  ...
                  const active = activeData.verifications?.find(
                    (v3) => v3.signalId === this.signalId
                  );
                  if (active?.steps?.length) {
                    activeSteps = active.steps.map((s5) => mapVerificationStep(s5, "running"));
              ...
              if (!activeSteps?.length && signalSteps.some(hasExplicitStepStatus)) {
                activeSteps = signalSteps.map((s5) => mapVerificationStep(s5, "running"));
              }
              if (activeSteps?.length) {
                this.steps = activeSteps;
                this.overallStatus = "running";
                for (let i6 = 0; i6 < this.steps.length; i6++) {
                  if (this.steps[i6].output && !this._stepOutputs.has(i6)) {
                    this._stepOutputs.set(i6, this.steps[i6].output);
                  }
                }
              }
            }
        ...
        _onEvent(e8) {
          ...
          switch (detail.type) {
            case "gate_verification_started": {
              this._stepOutputs = /* @__PURE__ */ new Map();
              this.modalStep = null;
              const stepDefs = detail.steps || [];
              const now = detail.startedAt || Date.now();
              const minPhase = stepDefs.length > 0 ? Math.min(...stepDefs.map((s5) => s5.phase ?? 0)) : 0;
              this.currentPhase = minPhase;
              this.steps = stepDefs.map((s5) => ({
                name: s5.name,
                type: s5.type,
                phase: s5.phase ?? 0,
                status: (s5.phase ?? 0) === minPhase ? "running" : "waiting",
                startedAt: now
              }));
              this.overallStatus = "running";
              break;
            ...
            case "gate_verification_phase_started": {
              const phase = detail.phase;
              const stepIndices = detail.stepIndices;
        ...
        render() {
          if (this.overallStatus === "idle" && this.steps.length === 0) {
            if (this.finalStatus === "passed") {
              return b2`<div class="mt-2 text-xs ${statusColor("completed")}">${statusIcon("completed")} Passed (no verification)</div>`;
            }
            if (this.finalStatus === "failed") {
              return b2`<div class="mt-2 text-xs ${statusColor("error")}">${statusIcon("error")} Failed</div>`;
            }
            return b2`<div class="mt-2 text-xs ${statusColor("running")}">Verification in progress…</div>`;
          }
          if (this.steps.length === 0 && this.overallStatus !== "running") {
            const dStatus = toDelegateStatus(this.overallStatus);
            return b2`<div class="mt-2 text-xs ${statusColor(dStatus)}">${statusIcon(dStatus)} ${this.overallStatus === "passed" ? "Passed (no verification)" : "Failed"}</div>`;
          }
          const passedCount = this.steps.filter((s5) => s5.status === "passed").length;
          const failedCount = this.steps.filter((s5) => s5.status === "failed").length;
          const total = this.steps.length;
          const summary = statusSummary(this.steps);
          const phases = new Set(this.steps.map((s5) => s5.phase ?? 0));
          const hasMultiplePhases = phases.size > 1;
          const stepsByPhase = /* @__PURE__ */ new Map();
          this.steps.forEach((step, i6) => {
            const p3 = step.phase ?? 0;
            if (!stepsByPhase.has(p3)) stepsByPhase.set(p3, []);
            stepsByPhase.get(p3).push({ step, index: i6 });
          });
          const sortedPhases = [...stepsByPhase.keys()].sort((a3, b4) => a3 - b4);
          const completedCount = passedCount + failedCount;
          const isRunning = this.overallStatus === "running";
          return b2`
			<div class="mt-2 space-y-1">
				${isRunning ? b2`<div class="flex items-center justify-end text-[10px] text-muted-foreground tabular-nums -mt-[1.35rem]">${summary || `${completedCount}/${total}`}</div>` : this._renderHeader(passedCount, failedCount, total, summary)}
				${sortedPhases.map((phase) => {
            const phaseSteps = stepsByPhase.get(phase);
            const isActive = phase === this.currentPhase && this.overallStatus === "running";
            return b2`
						${hasMultiplePhases ? b2`
        ...
        _renderHeader(passed, failed, total, summary) {
          if (this.overallStatus === "passed") {
            return b2`<div class="text-xs font-medium ${statusColor("completed")} mb-1">${statusIcon("completed")} Verified <code class="text-[10px]">${this.gateId}</code> — <span class="text-green-500">${summary || `${passed}/${total} passed`}</span></div>`;
          }
          if (this.overallStatus === "failed") {
            return b2`<div class="text-xs font-medium ${statusColor("error")} mb-1">${statusIcon("error")} Verified <code class="text-[10px]">${this.gateId}</code> — <span class="text-green-500">${passed} passed</span>, <span class="text-red-500">${failed} failed</span>${summary ? b2` <span class="text-muted-foreground">(${summary})</span>` : A}</div>`;
          }
          const completedCount = passed + failed;
          return b2`<div class="text-xs font-medium ${statusColor("running")} mb-1">Verifying <code class="text-[10px]">${this.gateId}</code> — <span class="text-xs">${summary || `${completedCount}/${total} steps`}</span></div>`;
        }
        _openModal(index, name) {
        ...
        _renderStepCard(step, index) {
          ...
          const typeBadgeCls = step.type === "command" ? "bg-muted text-muted-foreground" : "bg-purple-500/20 text-purple-600 dark:text-purple-400";
            ...
            if (isRunningCommand) {
              ...
              this._toggleStep(index);
				...
				>
					...
					${shouldRenderDuration(step) ? renderDuration(entry) : A}
					${step.sessionId ? renderSessionLink(step.sessionId) : A}
					${isRunningCommand ? b2`<span class="text-muted-foreground text-[10px] shrink-0" title="View live output">▸</span>` : A}
					${hasOutput ? b2`<span class="text-muted-foreground text-[10px] shrink-0">${isExpanded ? "\u25B4" : "\u25BE"}</span>` : A}
				</div>
				${isExpanded && hasOutput ? step.type !== "command" ? b2`<div class="text-xs text-muted-foreground max-h-[300px] overflow-y-auto bg-muted/50 rounded-b p-2 border-t border-border"><markdown-block .content=${displayOutput}></markdown-block></div>` : b2`<pre class="text-xs text-muted-foreground whitespace-pre-wrap max-h-[300px] overflow-y-auto bg-muted/50 rounded-b p-2 border-t border-border">${hasAnsi(displayOutput) ? o7(ansiToHtml(displayOutput)) : displayOutput}</pre>` : A}
			</div>
		`;
        }
      };
      GateVerificationLive._SEEN_CAP = 4096;
      __decorateClass([
        n6()
      ], GateVerificationLive.prototype, "goalId", 2);
      __decorateClass([
        n6()
      ], GateVerificationLive.prototype, "gateId", 2);
      __decorateClass([
        n6()
      ], GateVerificationLive.prototype, "signalId", 2);
      __decorateClass([
        n6()
      ], GateVerificationLive.prototype, "finalStatus", 2);
      __decorateClass([
        n6({ type: Array })
      ], GateVerificationLive.prototype, "initialSteps", 2);
      __decorateClass([
        r7()
      ], GateVerificationLive.prototype, "steps", 2);
      __decorateClass([
        r7()
      ], GateVerificationLive.prototype, "overallStatus", 2);
      __decorateClass([
        r7()
      ], GateVerificationLive.prototype, "currentPhase", 2);
      __decorateClass([
        r7()
      ], GateVerificationLive.prototype, "expandedSteps", 2);
      __decorateClass([
        r7()
      ], GateVerificationLive.prototype, "modalStep", 2);
      GateVerificationLive = __decorateClass([
        t5("gate-verification-live")
      ], GateVerificationLive);
    }
  });

  // tests/fixtures/gate-status-renderer-entry.ts
  init_lit();

  // src/ui/tools/renderers/GateToolRenderers.ts
  init_lit();
  init_ref2();
  init_lucide();
  ...
  function isSkippedToolResult(result) {
    ...
    const text2 = result.content?.filter((c5) => c5.type === "text").map((c5) => c5.text).join("") || "";
    return text2.includes("Skipped due to queued user message");
  }
  ...
  function renderHeader(state, toolIcon, text2, trailing) {
    const statusIcon2 = (iconComponent, color) => b2`<span class="inline-block ${color}">${icon(iconComponent, "sm")}</span>`;
    switch (state) {
      case "inprogress":
        return b2`
				<div class="flex items-center gap-2 text-sm text-muted-foreground">
					<div class="flex items-center gap-2 min-w-0">
						${statusIcon2(toolIcon, "text-foreground")}
						${text2}
					</div>
					${trailing ? b2`<span class="ml-auto flex items-center">${trailing}</span>` : b2`<span class="ml-auto"></span>`}
					${statusIcon2(Loader, "text-foreground animate-spin")}
				</div>
			`;
      case "complete":
        return b2`
				<div class="flex items-center gap-2 text-sm text-muted-foreground">
					<div class="flex items-center gap-2 min-w-0">
						${statusIcon2(toolIcon, "text-green-600 dark:text-green-500")}
						${text2}
					</div>
					${trailing ? b2`<span class="ml-auto flex items-center">${trailing}</span>` : A}
				</div>
			`;
      case "error":
        return b2`
				<div class="flex items-center gap-2 text-sm text-muted-foreground">
					<div class="flex items-center gap-2 min-w-0">
						${statusIcon2(toolIcon, "text-destructive")}
						${text2}
					</div>
					${trailing ? b2`<span class="ml-auto flex items-center">${trailing}</span>` : A}
				</div>
      ...
      case "warning":
        return b2`
				<div class="flex items-center gap-2 text-sm text-muted-foreground">
					<div class="flex items-center gap-2 min-w-0">
						${statusIcon2(toolIcon, "text-amber-600 dark:text-amber-500")}
						${text2}
					</div>
					${trailing ? b2`<span class="ml-auto flex items-center">${trailing}</span>` : A}
				</div>
  ...
  // src/ui/lazy/gate-verification-live.ts
  var loaded2 = false;
  function ensureGateVerificationLive() {
    if (loaded2) return;
    loaded2 = true;
    Promise.resolve().then(() => init_GateVerificationLive());
  }
  ...
  function getResult(result) {
    ...
    return { text: text2, data };
  }
  var GateStatusRenderer = class {
    render(params, result, isStreaming) {
      ...
      if (!result) {
        return {
          content: b2`<div>${renderHeader(state, ShieldCheck, b2`Checking gate <span class="font-mono">${gateId}</span>…`)}</div>`,
          isCustom: false
        };
      }
      const { data, text: text2 } = getResult(result);
      if (result.isError) {
        const skipped = isSkippedToolResult(result);
        return {
          content: b2`<div>
					${renderHeader(state, ShieldCheck, skipped ? b2`Aborted check of gate <span class="font-mono">${gateId}</span>` : b2`Failed to check gate <span class="font-mono">${gateId}</span>`)}
					<div class="mt-1 text-xs ${skipped ? "text-amber-600 dark:text-amber-400" : "text-destructive"}">${text2}</div>
				</div>`,
          isCustom: false
        };
      }
      if (!data) {
        return { content: b2`<div>${renderHeader(state, ShieldCheck, b2`Gate <span class="font-mono">${gateId}</span>`)}</div>`, isCustom: false };
      }
      ...
      const statusSuffix = gateStatus !== "pending" && !shouldRenderLiveVerification ? b2` — <span class="${gateStatus === "passed" ? "text-green-600 dark:text-green-400" : gateStatus === "failed" ? "text-red-600 dark:text-red-400" : ""}">${gateStatus}</span>` : "";
      return {
        content: b2`<div>
				${renderHeader(state, ShieldCheck, b2`Gate <span class="font-mono">${gateName}</span>${statusSuffix}`)}
				${deps.length ? b2`<div class="text-xs text-muted-foreground mt-1">Depends on: ${deps.join(", ")}</div>` : ""}
				${shouldRenderLiveVerification ? b2`
					<gate-verification-live
						.goalId=${goalId2}
						.gateId=${resolvedGateId}
						.signalId=${signalId}
						.finalStatus=${signalStatus === "passed" || signalStatus === "failed" ? signalStatus : void 0}
  ...
  // tests/fixtures/gate-status-renderer-entry.ts
  var GateVerificationLiveStub = class extends HTMLElement {
    constructor() {
      super(...arguments);
      this.goalId = "";
      this.gateId = "";
  ...
  async function renderStatus(params, data) {
    const container = document.getElementById("container");
    container.innerHTML = "";
    const renderer = new GateStatusRenderer();
    const out = renderer.render(params, toolResult(data));
    D(out.content, container);
    await Promise.resolve();
    const live = container.querySelector("gate-verification-live");
    return {
  ...
  window.__renderGateStatus = renderStatus;
  window.__ready = true;
})();
