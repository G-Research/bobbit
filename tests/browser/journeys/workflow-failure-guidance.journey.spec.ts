...
const PROJECT_ENTRY = path.resolve("tests/support/fixtures/browser/ui/goal-workflow-editor-entry.ts");
const EMBED_ENTRY = path.resolve("tests/support/fixtures/browser/ui/workflow-failure-guidance-embed-entry.ts");
