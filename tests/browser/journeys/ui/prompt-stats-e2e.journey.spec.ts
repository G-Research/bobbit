...
import { waitForHealth } from "../../_helpers/e2e-setup.js";
import { openApp, createSessionViaUI, sendMessage, waitForAgentResponse } from "../../../support/harnesses/browser/legacy-ui/ui-helpers.js";
...
test.describe("Prompt stats E2E", () => {
	...
	test("PI-17: context popover shows details on click", async ({ page }) => {
		...
		// to exist) â€” the stats arrive via a WS broadcast after the agent response,
