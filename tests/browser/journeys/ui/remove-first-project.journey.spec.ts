/**
 * Browser E2E â€” the Remove Project button renders for the first normal project
 * in Settings â†’ (project) â†’ General â†’ Danger Zone. Headquarters is anchored
 * first and immutable, so it is intentionally skipped for destructive removal.
 *
 * Pattern: navigate â†’ happy path â†’ assert removal in sidebar.
 */
...
test.describe("Settings â†’ Remove Project (first normal position)", () => {
