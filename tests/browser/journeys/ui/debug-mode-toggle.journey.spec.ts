...
// mode, so opt its describe block into the harness's existing worker option.
// It's the unified switch: it shows the floating DBG client-debug button AND
// arms boot-timing perf instrumentation (both localStorage-backed).
