 ...
 *   â€¢ the toggle renders immediately BELOW the "Show message timestamps" row;
 *   â€¢ enabling it replaces the sprite canvas with a `.bobbit-blob-text` label;
 *   â€¢ the preference persists across a full page reload;
 *   â€¢ disabling it restores the sprite canvas.
 */
