 ...
 * - Navigate away and back â€” tool block persists with "Open proposal" button
...
import { openApp, sendMessage, navigateToHash, createGoalAssistantViaUI } from "../../../support/harnesses/browser/legacy-ui/ui-helpers.js";
 ...
 * worst-case wait we've measured under full-suite parallel load (â‰ˆ30s for
