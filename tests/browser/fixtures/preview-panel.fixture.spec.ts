...
const ENTRY = path.resolve("tests/support/fixtures/browser/ui/preview-panel-entry.ts");
const DYNAMIC_WORKSPACE_ENTRY = path.resolve("tests/support/fixtures/browser/ui/dynamic-panel-workspace-fixture-entry.ts");
