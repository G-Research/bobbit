...
import { test, expect, type GatewayInfo } from "../../support/harnesses/browser/gateway-harness.js";
import { apiFetch, base, createSession, nonGitCwd, readE2ETokenAsync } from "../../support/harnesses/browser/e2e-setup.js";
