 ...
 *
 *   tests/support/fixtures/shared/multi-repo/api/      → real git repo with package.json
 *   tests/support/fixtures/shared/multi-repo/web/      → real git repo with package.json
 *   tests/support/fixtures/shared/multi-repo/shared/   → real git repo, README only (data-only)
 *
