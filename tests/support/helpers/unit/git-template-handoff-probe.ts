...
import { GIT_TEMPLATE_HANDOFF_PROOF_ENV } from "../../harnesses/shared/git-template-handoff-proof.js";
import { isTier1SpawnGuardInstalled } from "../../harnesses/unit/tier1-spawn-guard.js";
