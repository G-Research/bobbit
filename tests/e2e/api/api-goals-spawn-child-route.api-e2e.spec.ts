...
function configuredGitCwd(): string {
	if (spawnChildGitRoot) return spawnChildGitRoot;
	...
	Object.assign(process.env, {
		...
		GIT_AUTHOR_EMAIL: "bobbit-test@example.invalid",
		GIT_COMMITTER_NAME: "Bobbit Test",
		GIT_COMMITTER_EMAIL: "bobbit-test@example.invalid",
	});
	try {
		spawnChildGitRoot = gitCwd();
		return spawnChildGitRoot;
	} finally {
