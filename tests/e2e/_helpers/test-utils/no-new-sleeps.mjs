 ...
 *
 * Usage:
 *   node tests/e2e/_helpers/test-utils/no-new-sleeps.mjs           # check
 *   node tests/e2e/_helpers/test-utils/no-new-sleeps.mjs --update  # refresh baseline (lower-only)
 *   node tests/e2e/_helpers/test-utils/no-new-sleeps.mjs --reset   # rebaseline from current state
 *
...
function main() {
	...
	if (violations.length > 0) {
		...
		console.error(`\nReplace hardcoded sleeps with event-driven waits from tests/e2e/_helpers/e2e-setup.ts:`);
