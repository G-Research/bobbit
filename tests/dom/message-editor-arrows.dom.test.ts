...
// dom/mobile-archived.dom.test.ts) — we reproduce the fixture's exact history state
...
//
// Distinct from dom/command-history.dom.test.ts (dedup only) and
// dom/message-editor-ctrl-arrow.dom.test.ts (Ctrl+Arrow modifier guard).
