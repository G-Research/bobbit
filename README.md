...
| [Code Intelligence](docs/code-intelligence.md) | Optional server-scoped structural search, graph status, LSP capability limits, and verification guidance |
| [AST Structural Search](docs/ast-structural-search.md) | Read-only syntax-aware search with `ast_grep` |
