var je=["cost.totalUsd","cost.tokensTotal","cost.cacheHitRate","gates.passRate","gates.firstPassClean","tasks.completionRate","time.wallClockMs","objective.value","command.metric"],Be={"cost.totalUsd":"lower-better","cost.tokensTotal":"lower-better","cost.cacheHitRate":"higher-better","gates.passRate":"higher-better","gates.firstPassClean":"higher-better","tasks.completionRate":"higher-better","time.wallClockMs":"lower-better","objective.value":"higher-better","command.metric":"neutral"},Oe=new Set(["cost.totalUsd","time.wallClockMs","gates.passRate","objective.value"]),K=[{id:"comparison-table",label:"Comparison table"},{id:"score-bars",label:"Score bars"},{id:"objective-curve",label:"Objective curve"},{id:"ledger-table",label:"Ledger"},{id:"summary-cards",label:"Summary cards"},{id:"raw-drilldown",label:"Raw runs"}],Ne=["median","mean","p90","min","max","count"],A={exp:n=>`exp/${n}`,state:n=>`exp/${n}/state`,runPrefix:n=>`exp/${n}/run/`,ledger:n=>`exp/${n}/ledger`,dashboard:n=>`exp/${n}/dashboard`,metrics:n=>`exp/${n}/metrics`,index:"index/experiments",draft:n=>`drafts/${n}`},De="bobbit:experiment-runner:draft:",f=n=>Array.isArray(n)?n:[],u=(n,l="")=>n==null?l:String(n),y=n=>{let l=Number(n);return Number.isFinite(l)?l:void 0},D=n=>u(n,"exp").replace(/[^a-zA-Z0-9_-]+/g,"-").replace(/^-+|-+$/g,"")||"exp";function Ue(n){let l=u(n).trim();if(l==="")return"";if(/^-?\d+(\.\d+)?$/.test(l))return Number(l);if(l==="true")return!0;if(l==="false")return!1;if(l.startsWith("{")&&l.endsWith("}")||l.startsWith("[")&&l.endsWith("]"))try{return JSON.parse(l)}catch{}return l}function V(n){let l={};for(let w of f(n)){let h=u(w&&w.key).trim();h&&(l[h]=Ue(w&&w.value))}return l}function W(n){let l=u(n).trim();if(l)try{let w=JSON.parse(l);return w&&typeof w=="object"?w:void 0}catch{return}}var Pe=n=>{let l=n.filter(h=>Number.isFinite(h)).slice().sort((h,k)=>h-k);if(!l.length)return;let w=Math.floor(l.length/2);return l.length%2?l[w]:(l[w-1]+l[w])/2},ee=(n,l)=>{let w=n.filter(h=>Number.isFinite(h));if(l==="count")return w.length;if(w.length)switch(l){case"mean":return w.reduce((h,k)=>h+k,0)/w.length;case"min":return Math.min(...w);case"max":return Math.max(...w);case"p90":{let h=w.slice().sort((k,S)=>k-S);return h[Math.min(h.length-1,Math.floor(.9*h.length))]}default:return Pe(w)}},O=n=>{if(n==null||!Number.isFinite(n))return"\u2014";let l=Math.abs(n);return l!==0&&l<.01?n.toExponential(2):Number.isInteger(n)?String(n):n.toFixed(l>=100?1:3)},N=n=>n==null||!Number.isFinite(n)?"\u2014":`$${n.toFixed(2)}`;function q(){return[{key:"",value:""}]}function ae(){return je.map(n=>({metric:n,source:"built-in",collect:Oe.has(n),aggregation:"median",direction:Be[n]||"neutral",primary:n==="gates.passRate"}))}function H(){return{view:"mode-select",mode:null,experimentId:void 0,basics:{name:"",runnableUnit:"command",body:"",workflowId:""},ab:{variants:[{label:"baseline",metadata:q(),rolesJson:"",rolesOpen:!1},{label:"variant-b",metadata:q(),rolesJson:"",rolesOpen:!1}],repeats:3,sameCompletionBar:!0,concurrency:3},auto:{objectiveMetric:"objective.value",direction:"maximize",correctnessGateId:"",seed:q(),seedRolesJson:"",caps:{maxIterations:"",wallClockHours:"",costUsd:"",perIterBudget:""},stops:{plateauK:"",target:""},strategy:"greedy",batchSize:""},metrics:ae(),perRunBudget:"",confirmAck:!1}}var E=globalThis.__bobbitExperimentRunnerState||(globalThis.__bobbitExperimentRunnerState=new Map);function Le(n){let l=[],w=n.basics||{};u(w.name).trim()||l.push("Name is required"),u(w.body).trim()||l.push("Spec / command body is required");let h=f(n.ab&&n.ab.variants);h.length<2&&l.push("A/B needs at least two variants");let k=new Set,S=[];h.forEach((I,j)=>{let L=u(I.label).trim();L?k.has(L)&&l.push(`Variant label "${L}" is duplicated`):l.push(`Variant ${j+1} needs a label`),k.add(L),S.push(JSON.stringify({m:V(I.metadata),r:W(I.rolesJson)||null}))});for(let I=0;I<S.length;I++)for(let j=I+1;j<S.length;j++)S[I]===S[j]&&l.push(`Variant "${u(h[j].label).trim()||j+1}" is identical to "${u(h[I].label).trim()||I+1}"`);let C=y(n.ab&&n.ab.repeats);(!C||C<1)&&l.push("Repeats must be \u2265 1");let v=y(n.perRunBudget);(!v||v<=0)&&l.push("Set a per-run budget");let T=y(n.ab&&n.ab.concurrency);T!=null&&(T<1||T>8)&&l.push("Concurrency must be 1\u20138"),f(n.metrics).some(I=>I.collect)||l.push("Select at least one metric");let M=h.length*(C||0),P=v?M*v:void 0;return{valid:l.length===0,errors:l,runCount:M,estCostMax:P}}function Fe(n){let l=[],w=[],h=n.basics||{};u(h.name).trim()||l.push("Name is required"),u(h.body).trim()||l.push("Spec / command body is required");let k=n.auto||{};u(k.objectiveMetric).trim()||l.push("Choose an objective metric");let S=y(k.caps&&k.caps.perIterBudget);(!S||S<=0)&&l.push("Set a per-iteration budget");let C=k.caps||{},v=y(C.maxIterations)>0||y(C.wallClockHours)>0||y(C.costUsd)>0,T=k.stops||{},M=y(T.plateauK)>0||T.target!==""&&Number.isFinite(y(T.target));v||w.push("Set at least one hard cap (max-iterations, wall-clock, or cost)"),M||w.push("Set at least one stop condition (plateau-K or target)"),n.confirmAck||w.push("Acknowledge the autonomous-run warning");let P=y(C.maxIterations),I=y(C.costUsd),j;return S&&P&&(j=P*S),I!=null&&(j=j==null?I:Math.min(j,I)),{valid:l.length===0&&w.length===0,errors:l,checklist:w,estCostMax:j,hasCap:v,hasStop:M}}function te(n){return n.mode==="autoresearch"?Fe(n):Le(n)}function _e(n){let l=n.basics||{},w={"higher-better":"max","lower-better":"min"},h=f(n.metrics).filter(v=>v.collect).map(v=>{let T={metricId:v.metric,aggregation:v.aggregation,primary:!!v.primary},M=w[v.direction];return M&&(T.directionOverride=M),T}),S=l.runnableUnit==="command"?{kind:"command",command:u(l.body)}:{kind:"agent",spec:u(l.body)},C={experimentId:n.experimentId,title:u(l.name).trim(),mode:n.mode==="autoresearch"?"autoresearch":"ab",runnable:S,workflowId:u(l.workflowId).trim()||void 0,metrics:h};if(C.mode==="ab"){let v=n.ab||{};C.variants=f(v.variants).map((T,M)=>({armId:D(u(T.label).trim()||`arm-${M}`),label:u(T.label).trim()||`arm-${M}`,metadata:V(T.metadata),inlineRoles:W(T.rolesJson)})),C.repeats=y(v.repeats)||1,C.sameCompletionBar=v.sameCompletionBar!==!1,C.maxConcurrency=y(v.concurrency)||3,C.perRunBudget=y(n.perRunBudget)}else{let v=n.auto||{};C.objective={metricId:v.objectiveMetric,direction:v.direction==="minimize"?"min":"max"},C.correctnessGateId=u(v.correctnessGateId).trim()||void 0,C.seed={metadata:V(v.seed),inlineRoles:W(v.seedRolesJson)};let T=y(v.caps&&v.caps.wallClockHours);C.caps={maxIterations:y(v.caps&&v.caps.maxIterations),maxWallClockMs:T?T*36e5:void 0,maxCostUsd:y(v.caps&&v.caps.costUsd)};let M=y(v.stops&&v.stops.target);C.stop={plateauK:y(v.stops&&v.stops.plateauK)},M!=null&&(C.stop.target=M),C.strategy=v.strategy==="best-of-batch"?"best-of-batch":"greedy",C.batchSize=y(v.batchSize),C.perRunBudget=y(v.caps&&v.caps.perIterBudget)}return C}function qe({html:n,nothing:l,renderHeader:w}){let h=async(e,t,r)=>{try{if(!e||!e.capabilities||!e.capabilities.callRoute||!e.callRoute)return{ok:!1,error:"routes-unavailable"};let a=await e.callRoute(t,r);return a&&typeof a=="object"&&a.error?{ok:!1,error:a.error}:{ok:!0,data:a}}catch(a){return{ok:!1,error:a&&a.message?String(a.message):String(a)}}},k=async(e,t)=>{try{return e&&e.store&&e.store.get?await e.store.get(t):null}catch{return null}},S=async(e,t,r)=>{try{e&&e.store&&e.store.put&&await e.store.put(t,r)}catch{}},C=async(e,t)=>{try{return e&&e.store&&e.store.list?await e.store.list(t)||[]:[]}catch{return[]}},v=e=>{try{e&&e.requestRender&&e.requestRender()}catch{}},T=(e,t)=>{try{e&&e.capabilities&&e.capabilities.ui&&e.ui&&e.ui.navigate&&e.ui.navigate({route:"experiment-runner",params:t})}catch{}},M=e=>`${De}${D(e)}`,P=e=>{try{let t=globalThis.localStorage&&globalThis.localStorage.getItem(M(e));return t?JSON.parse(t):void 0}catch{return}},I=(e,t)=>{try{globalThis.localStorage&&globalThis.localStorage.setItem(M(e),JSON.stringify(t))}catch{}},j=e=>E.get(e),L=(e,t,r)=>{E.set(t,r),v(e)},z=(e,t,r)=>{let s={...E.get(t)||{},...r};return E.set(t,s),v(e),s},R=(e,t,r)=>{let a=E.get(t)||{},s={...a.draft||H()};r(s);let i={...a,draft:s};E.set(t,i),I(t,s),S(a.host,A.draft(t),s),v(e)};function re(e,t,r,a){let s=E.get(t);return s&&s.hydrated?(s.host=e,r&&s.draft&&s.draft.experimentId!==r&&se(e,t,r,a),s):(s={hydrated:!1,host:e,draft:P(t)||H(),dashboard:null,experiments:[]},E.set(t,s),(async()=>{let i=await k(e,A.draft(t)),c=E.get(t)||s,d=i&&typeof i=="object"?i:c.draft;r&&(d={...d,experimentId:r,view:a||"dashboard"}),E.set(t,{...c,hydrated:!0,draft:d}),v(e),ne(e,t),d.experimentId&&d.view==="dashboard"&&U(e,t,d.experimentId)})(),E.get(t))}let X=e=>({experimentId:e.experimentId,title:u(e.title,e.experimentId),mode:e.mode==="autoresearch"?"autoresearch":"ab"});async function ne(e,t){let r=await h(e,"listExperiments",{method:"GET"}),a=[];if(r.ok&&Array.isArray(r.data))a=r.data.filter(s=>s&&typeof s=="object").map(X);else{let s=f(await k(e,A.index)).filter(c=>typeof c=="string");a=(await Promise.all(s.map(c=>k(e,A.exp(c))))).filter(c=>c&&typeof c=="object").map(X)}z(e,t,{experiments:a})}async function se(e,t,r,a){R(e,t,s=>{s.experimentId=r,s.view=a||"dashboard"}),await U(e,t,r)}async function U(e,t,r){z(e,t,{dashboardLoading:!0});let a,s,i=[],c=[],d,o,p=await h(e,"getExperiment",{method:"GET",query:{experimentId:r}});if(p.ok&&p.data&&p.data.def&&(a=p.data.def,s=p.data.state,i=f(p.data.runs),c=f(p.data.ledger),d=p.data.dashboard,o=p.data.metrics),!a){a=await k(e,A.exp(r)),s=await k(e,A.state(r)),c=f(await k(e,A.ledger(r))),d=await k(e,A.dashboard(r)),o=await k(e,A.metrics(r));let x=await C(e,A.runPrefix(r));for(let $ of x){let B=await k(e,$);B&&typeof B=="object"&&i.push(B)}}if(d==null&&(d=await k(e,A.dashboard(r))),!f(o).length){let x=await k(e,A.metrics(r));f(x).length&&(o=x)}let g=x=>f(x).some($=>$&&$.status==="settled");if(s&&s.status==="running")if(a&&a.mode==="autoresearch"){let x=await h(e,"iterate",{method:"POST",body:{experimentId:r}});x.ok&&x.data&&Array.isArray(x.data.ledger)&&(c=x.data.ledger);let $=await h(e,"getExperiment",{method:"GET",query:{experimentId:r}});$.ok&&$.data&&$.data.def&&(s=$.data.state,i=f($.data.runs),f($.data.ledger).length&&(c=$.data.ledger))}else{let x=await h(e,"poll",{method:"POST",body:{experimentId:r}});if(x.ok&&x.data&&Array.isArray(x.data.runs)&&(i=x.data.runs),g(i)){let $=await h(e,"collect",{method:"POST",body:{experimentId:r}});$.ok&&$.data&&Array.isArray($.data.runs)&&(i=$.data.runs)}}let m=await h(e,"report",{method:"POST",body:{experimentId:r}}),b=m.ok&&m.data?m.data:null;z(e,t,{dashboardLoading:!1,dashboard:{experimentId:r,def:a,state:s,runs:i,ledger:c,spec:d,metrics:f(o).length?o:a&&a.metrics||[],report:b}})}async function ie(e,t){let a=E.get(t).draft;z(e,t,{launching:!0,launchError:void 0});let s=_e(a),i=await h(e,"defineExperiment",{method:"POST",body:s});if(!i.ok&&i.error!=="routes-unavailable"){z(e,t,{launching:!1,launchError:i.error});return}let c=a.experimentId;i.ok&&i.data&&i.data.experimentId&&(c=i.data.experimentId),c||(c=`${D(s.title)}-${Date.now().toString(36)}`),s.experimentId=c,await S(e,A.exp(c),s),await S(e,A.metrics(c),s.metrics),await oe(e,t,{experimentId:c,title:s.title,mode:s.mode,status:"running"});let d=s.mode==="autoresearch"?"iterate":"launch",o=await h(e,d,{method:"POST",body:{experimentId:c}});if(!o.ok&&o.error!=="routes-unavailable"){z(e,t,{launching:!1,launchError:o.error});return}R(e,t,p=>{p.experimentId=c,p.view="dashboard"}),z(e,t,{launching:!1}),T(e,{experimentId:c,view:"dashboard"}),await U(e,t,c)}async function oe(e,t,r){let a=f(await k(e,A.index)).filter(c=>typeof c=="string"&&c!==r.experimentId);a.push(r.experimentId),await S(e,A.index,a);let s=E.get(t)||{},i=f(s.experiments).filter(c=>c.experimentId!==r.experimentId);i.push(r),z(e,t,{experiments:i})}async function ce(e,t,r){await h(e,"cancel",{method:"POST",body:{experimentId:r}}),await U(e,t,r)}async function de(e,t,r,a){await h(e,"saveMetrics",{method:"POST",body:{experimentId:r,metrics:a}}),await S(e,A.metrics(r),a),await U(e,t,r)}async function le(e,t,r,a){let s=Array.isArray(a)?{widgets:a}:a&&Array.isArray(a.widgets)?a:{widgets:[]};await h(e,"saveDashboard",{method:"POST",body:{experimentId:r,dashboard:s}}),await S(e,A.dashboard(r),s),z(e,t,{dashboardEditing:!1}),await U(e,t,r)}let G=(e,t,r)=>R(e,t,a=>{a.view=r});function pe(e,t,r){let a=s=>R(e,t,i=>{i.mode=s,i.view="define"});return n`
		...
		`}function xe(e,t,r){let a=f(r.metrics),s=(i,c)=>R(e,t,d=>{let o=f(d.metrics).slice();c.primary&&o.forEach((p,g)=>{o[g]={...p,primary:g===i}}),o[i]={...o[i],...c},d.metrics=o});return n`
		...
		`}function be(e,t,r){let a=r.ab||{},s=f(a.variants),i=g=>R(e,t,m=>{m.ab={...m.ab,...g}}),c=(g,m)=>R(e,t,b=>{let x=f(b.ab.variants).slice();x[g]={...x[g],...m},b.ab={...b.ab,variants:x}}),d=g=>R(e,t,m=>{let b=f(m.ab.variants).slice();b.splice(g,1),m.ab={...m.ab,variants:b}}),o=g=>R(e,t,m=>{let b=f(m.ab.variants).slice(),x=g!=null?b[g]:null;b.push({label:`variant-${b.length+1}`,metadata:x?x.metadata.map($=>({...$})):q(),rolesJson:x?x.rolesJson:"",rolesOpen:!1}),m.ab={...m.ab,variants:b}}),p=y(a.repeats);return n`
			<section class="exp-card" data-testid="experiment-runner-ab-form">
				...
				${s.map((g,m)=>n`
					<div class="exp-variant" data-testid="experiment-runner-variant-row" data-variant-index=${m}>
						...
						${Y(e,t,g.metadata,b=>R(e,t,x=>{let $=f(x.ab&&x.ab.variants).slice(),B=f($[m]&&$[m].metadata).slice();$[m]={...$[m],metadata:b(B)},x.ab={...x.ab,variants:$}}),"experiment-runner-variant-metadata")}
		...
		`}function me(e,t,r){let a=r.auto||{},s=o=>R(e,t,p=>{p.auto={...p.auto,...o}}),i=o=>R(e,t,p=>{p.auto={...p.auto,caps:{...p.auto.caps,...o}}}),c=o=>R(e,t,p=>{p.auto={...p.auto,stops:{...p.auto.stops,...o}}}),d=f(r.metrics).map(o=>o.metric);return n`
			...
			<section class="exp-card" data-testid="experiment-runner-auto-objective">
				...
				${Y(e,t,a.seed,o=>R(e,t,p=>{p.auto={...p.auto,seed:o(f(p.auto&&p.auto.seed).slice())}}),"experiment-runner-seed-metadata")}
			</section>
		...
		`}function Z(e){let t=e&&Array.isArray(e.spec)?e.spec:e&&e.spec&&Array.isArray(e.spec.widgets)?e.spec.widgets:null;return t&&t.length?t:e&&e.def&&e.def.mode==="autoresearch"?[{type:"summary-cards",title:"Summary"},{type:"objective-curve",title:"Best objective vs iteration"},{type:"ledger-table",title:"Ledger"},{type:"raw-drilldown",title:"Iterations"}]:[{type:"summary-cards",title:"Summary"},{type:"comparison-table",title:"Comparison"},{type:"score-bars",title:"Secondary metrics"},{type:"raw-drilldown",title:"Runs"}]}let F=e=>e&&(e.metricId||e.metric)||void 0;function J(e){let r=f(e&&e.metrics).filter(a=>a.collect!==!1).map(F).filter(Boolean);return r.length?r:["objective.value","cost.totalUsd","time.wallClockMs"]}function he(e){let r=f(e&&e.metrics).find(a=>a.primary);return r?F(r):e&&e.def&&e.def.objective?e.def.objective.metricId||e.def.objective.metric:J(e)[0]}let _=(e,t)=>{let r=e&&e.metrics,a=r?r[t]:void 0;return Number.isFinite(Number(a))?Number(a):a&&Number.isFinite(Number(a.value))?Number(a.value):void 0};function Q(e){let t=new Map;for(let r of f(e&&e.runs)){let a=u(r.armId,"arm");t.has(a)||t.set(a,[]),t.get(a).push(r)}return t}function $e(e,t){let r=J(t),a=!(t.def&&t.def.sameCompletionBar===!1),s=Q(t),i=f(t.metrics),c=d=>(i.find(o=>F(o)===d)||{}).aggregation||"median";return n`<table class="exp-table" data-testid="experiment-runner-widget-comparison-table">
		...
		</div>`}function Se(e,t){let r=J(t),a=f(t.runs);return n`<table class="exp-table" data-testid="experiment-runner-widget-raw-drilldown">
		...
		</div>`}function Ae(e,t,r){let a=Z(r).slice(),s=b=>z(e,t,{dashboardDraftSpec:b}),i=E.get(t)||{},c=i.dashboardDraftSpec||a,d=(b,x)=>{let $=c.slice(),B=b+x;B<0||B>=$.length||([$[b],$[B]]=[$[B],$[b]],s($))},o=b=>{let x=c.slice();x.splice(b,1),s(x)},p=b=>s([...c,{type:b,title:(K.find(x=>x.id===b)||{}).label||b}]),g=(b,x)=>{let $=c.slice();$[b]={...$[b],title:x},s($)},m=i.widgetTypes&&i.widgetTypes.length?i.widgetTypes:K;return n`<div class="exp-card" data-testid="experiment-runner-dashboard-editor">
			...
			${c.map((b,x)=>n`<div class="exp-editor-row" data-testid="experiment-runner-editor-widget" data-widget-type=${b.type}>
				<input class="exp-input" type="text" .value=${u(b.title)} @input=${$=>g(x,$.currentTarget.value)} />
			...
			</div>`;let c=s.def||{},d=s.state||{},o=c.mode==="autoresearch",p=u(d.status,"running"),g=f(s.runs),m=g.filter(x=>["settled","collected","failed"].includes(x.status)).length,b=d.stopReason?`stopped: ${d.stopReason}`:p;return n`
		...
		`}function Ee(e,t,r){let a=f(r.metrics).length?f(r.metrics):ae(),s=(i,c)=>{let d=a.map((o,p)=>p===i?{...o,collect:c}:o);z(e,t,{dashboard:{...r,metrics:d}}),de(e,t,r.experimentId,d)};return n`<table class="exp-table">
